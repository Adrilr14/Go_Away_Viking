...
Hexadecimal [16-Bits]
                             ...
                             29 
                             30 .module sys_ai_control
                             31 
                             32 ;; INITS THE AI-CONTROL SYSTEM
                             33 
   29E8                      34 sys_ai_control_init::
                             35 ;;; TODO REMOVE TEMPORAL
                             36     ;;ld      (_ent_array_otr_temp_standby), ix
                             37     ;;ld      (m_first_entity_free), ix
                             38 
   29E8 C9            [10]   39 ret
                             40 
                             41 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             42 ;;SYS AI CONTROL:: Update
                             43 ;; Updates all AI entities
                             44 ;;INPUT
                             45 ;;  IX; Pointer to the entity array
                             46 ;;  A: Number of elements in the array
                             47 ;;DESTROYS: AF, BC, DE, IX
                             48 ;;STACK USE: 2 bytes
                             49 ;;
   29E9                      50 sys_ai_control_update::
                             51 
   29E9 DD 7E 0E      [19]   52     ld      a, e_ai_st(ix)
   29EC FE 00         [ 7]   53     cp      #e_ai_st_noAI
   29EE 28 0F         [12]   54     jr      z,_no_AI_ent
                             55 
   29F0                      56 _AI_ent:
                             57 
   29F0 FE 01         [ 7]   58     cp      #e_ai_st_stand_by
   29F2 CC 00 2A      [17]   59     call    z, sys_ai_stand_by
   29F5 FE 02         [ 7]   60     cp      #e_ai_st_move_to
   29F7 CC 0C 2A      [17]   61     call    z, sys_ai_move_to
   29FA FE 04         [ 7]   62     cp      #e_ai_st_patrol
   29FC CC 51 2A      [17]   63     call    z, sys_ai_patrol
                             64 
   29FF                      65 _no_AI_ent:
                             66 
   29FF C9            [10]   67     ret
                             ...
                             74 
                             75 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             76 ;;SYS AI CONTROL::stand_by
                             77 ;;  An entity waiting for an event occur
                             78 ;;INPUT
                             79 ;;  IX: = Pointer to the entity
                             80 ;;DESTROYS; AF, IY
                             81 ;;
                             82 
   2A00                      83 sys_ai_stand_by::
...
Hexadecimal [16-Bits]
                             ...
                             84 
                             85     ;; Guardamos el hero en IY
   2A00 CD 36 32      [17]   86     call    man_entity_getEntity_hero_IY
                             87 
   2A03 DD 36 0F 01   [19]   88     ld      e_ai_pre_st(ix), #e_ai_st_stand_by      ;; El enemigo utiliza e_ai_pre_st para guardar el estado anterior
   2A07 DD 36 0E 04   [19]   89     ld      e_ai_st(ix), #e_ai_st_patrol
                             90 
   2A0B C9            [10]   91 ret
                             92 
                             93 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             94 ;;SYS AI CONTROL::move_to
                             95 ;;  The entity changes its velocity to move
                             96 ;;      to an X, Y location (e_ai_aim_x, e_ai_aim_y )
                             97 ;;INPUT
                             98 ;;  IX: = Pointer to the entity
                             99 ;;DESTROYS; AF, IY
                            100 ;;
                            101 
   2A0C                     102 sys_ai_move_to::
                            103     ;;ld      e_vy(ix), #0
                            104 
                            105 ;;UPDATE X
                            106     ;;ld      c, #0
   2A0C DD 7E 0C      [19]  107     ld      a, e_ai_aim_x(ix)   ;; A = x_objetivo
   2A0F DD 96 02      [19]  108     sub     e_x(ix)             ;; A = obj_x - x
   2A12 30 06         [12]  109     jr      nc, _objx_greater_or_equal    ;; if (obj_x - x > 0)
                            110 
   2A14                     111 _objx_lesser:
   2A14 DD 36 04 FF   [19]  112     ld      e_vx(ix), #-1
   2A18 18 0C         [12]  113     jr      _endif_x
                            114 
   2A1A                     115 _objx_greater_or_equal:
   2A1A 28 06         [12]  116     jr      z, _arrived_x
   2A1C DD 36 04 01   [19]  117     ld      e_vx(ix), #1
   2A20 18 04         [12]  118     jr      _endif_x
                            119 
   2A22                     120 _arrived_x:
                            121 
   2A22 DD 36 04 00   [19]  122     ld      e_vx(ix), #0
                            123 
   2A26                     124 _endif_x:
                            125 ;;UPDATE Y
   2A26 DD 7E 0D      [19]  126     ld      a, e_ai_aim_y(ix)   ;; A = y_objetivo
   2A29 DD 96 03      [19]  127     sub     e_y(ix)             ;; A = obj_y - y
   2A2C 30 06         [12]  128     jr      nc, _objy_greater_or_equal    ;; if (obj_y - y > 0)
                            129 
   2A2E                     130 _objy_lesser:
   2A2E DD 36 05 FE   [19]  131     ld      e_vy(ix), #-2
   2A32 18 1C         [12]  132     jr      _endif_y
                            133 
   2A34                     134 _objy_greater_or_equal:
   2A34 28 06         [12]  135     jr      z, _arrived_y
   2A36 DD 36 05 02   [19]  136     ld      e_vy(ix), #2
   2A3A 18 14         [12]  137     jr      _endif_y
                            138 
...
Hexadecimal [16-Bits]
   ...
   2A3C                     139 _arrived_y:
   2A3C DD 36 05 00   [19]  140     ld      e_vy(ix), #0
   2A40 DD 7E 04      [19]  141     ld      a, e_vx(ix)
   2A43 B7            [ 4]  142     or      a 
   2A44 20 0A         [12]  143     jr      nz, _endif_y
                            144     ;; X and Y are both 0
   2A46 DD 7E 0F      [19]  145     ld      a, e_ai_pre_st(ix)
   2A49 DD 77 0E      [19]  146     ld      e_ai_st(ix), a
   2A4C DD 36 0F 02   [19]  147     ld      e_ai_pre_st(ix), #e_ai_st_move_to
   2A50                     148 _endif_y:
   2A50 C9            [10]  149     ret
                            150 
                            151 
                            152 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            153 ;;SYS AI CONTROL::patrol
                            154 
                            155 ;;INPUT
                            156 ;;  IX: = Pointer to the entity
                            157 ;;DESTROYS; AF, IY
                            158 ;;
                            159 
   2A51                     160 sys_ai_patrol::
                            161     ;;HL Points to next (X,Y) AI patrol step. AQUI LO LEO
   2A51 DD 6E 10      [19]  162     ld      l, e_ai_patrol_step_l(ix)
   2A54 DD 66 11      [19]  163     ld      h, e_ai_patrol_step_h(ix) ;;con esto tendria en hl el puntero que me he guardado
                            164 
                            165     ;;COMPROBAR X != -1
   2A57 7E            [ 7]  166     ld      a, (hl)
   2A58 FE FF         [ 7]  167     cp      #patrol_invalid_move_x
   2A5A 28 19         [12]  168     jr      z, _reset_patrol
                            169 
                            170     ;;Set AI-AIM(X,Y)
   2A5C 7E            [ 7]  171     ld      a, (hl) ;; A  = x
   2A5D DD 77 0C      [19]  172     ld      e_ai_aim_x(ix), a
                            173     
   2A60 23            [ 6]  174     inc     hl                  ;;Point to y
   2A61 7E            [ 7]  175     ld      a, (hl) ;; A  = x
   2A62 DD 77 0D      [19]  176     ld      e_ai_aim_y(ix), a
                            177 
                            178     ;;SET e ai patrol_step + 1. AQUI ACTUALIZO HL SUMANDO UNO
   2A65 23            [ 6]  179     inc     hl
   2A66 DD 75 10      [19]  180     ld      e_ai_patrol_step_l(ix), l
   2A69 DD 74 11      [19]  181     ld      e_ai_patrol_step_h(ix), h
                            182 
                            183     ;;CHANGE TO move to
   2A6C DD 36 0F 04   [19]  184     ld      e_ai_pre_st(ix), #e_ai_st_patrol       ;; El enemigo utiliza e_ai_pre_st para guardar el estado anterior
   2A70 DD 36 0E 02   [19]  185     ld      e_ai_st(ix), #e_ai_st_move_to
                            186 
   2A74 C9            [10]  187     ret
                            188 
   2A75                     189 _reset_patrol:
                            190     ;;GET Next 2 bytes pointed by HL, which point to the start of the patrol
   2A75 23            [ 6]  191     inc     hl
   2A76 7E            [ 7]  192     ld      a, (hl)
   2A77 23            [ 6]  193     inc     hl 
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 63.
Hexadecimal [16-Bits]



   2A78 66            [ 7]  194     ld      h, (hl)
                            195 
                            196     ;;Reset patrol_step
   2A79 DD 77 10      [19]  197     ld      e_ai_patrol_step_l(ix), a
   2A7C DD 74 11      [19]  198     ld      e_ai_patrol_step_h(ix), h 
   2A7F C9            [10]  199 ret
                            200 
