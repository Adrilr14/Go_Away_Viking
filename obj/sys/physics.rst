...
Hexadecimal [16-Bits]
                             ...
                             32 
   2D46 02                   33 direccion_hammer:   .db 2           ;; Si es 2 irá hacia la derecha, y si es -2 (0xFE) a la izquierda
                             34 
                             35 ;;
                             36 ;; UPDATE
                             37 ;;      Moves every entities
                             38 ;; Input
                             39 ;;      IX: Entity to move
                             40 ;;
   2D47                      41 sys_physics_update::
                             42 
   2D47 DD 7E 01      [19]   43     ld      a, e_object(ix)
   2D4A E6 02         [ 7]   44     and     #e_object_enemy
   2D4C C2 94 2E      [10]   45     jp      nz, entity_enemy_move
                             46 
   2D4F DD 7E 01      [19]   47     ld      a, e_object(ix)
   2D52 D6 20         [ 7]   48     sub     #e_object_hammer            ;; No se hace and porque se le añade al hero el object hammer (martillo) y entonces
   2D54 CA FC 2E      [10]   49     jp      z, entity_hammer_lado_move  ;; entra a esta función y no a la suya, así solo entra si tiene SOLO el object hammer
                             50 
                             51 
   2D57                      52 entity_moveKeyboard::
                             53 
   2D57 DD 7E 0B      [19]   54     ld      a, e_frame(ix)
   2D5A D6 FF         [ 7]   55     sub     #e_frame_activo
   2D5C C2 8B 2E      [10]   56     jp      nz, move_hero_after_init
                             57 
                             58     ;;call    cpct_scanKeyboard_asm ;;llamamos se escanea y ya
   2D5F 21 04 04      [10]   59     ld      hl, #Key_O
   2D62 CD 35 5B      [17]   60     call    cpct_isKeyPressed_asm ;;tenemos que mandarle la tecla que queremos saber si esta pulsada
   2D65 28 14         [12]   61     jr      z, o_no_pulsada  ;;si me quiero mover a la izquierda hay que restar -1
   2D67 DD 7E 09      [19]   62     ld      a, e_ladder(ix)
   2D6A EE 01         [ 7]   63     xor     #e_ladder_up
   2D6C EE 02         [ 7]   64     xor     #e_ladder_down
   2D6E 28 0B         [12]   65     jr      z, o_no_pulsada
                             66     ;; Comprobamos que no tenga una entidad invisible a la izquierda
   2D70 DD 7E 0A      [19]   67     ld      a, e_invisible(ix)
   2D73 EE 01         [ 7]   68     xor     #e_invisible_left
   2D75 28 04         [12]   69     jr      z, o_no_pulsada
                             70 
                             71     ;;ld      e_ai_aim_x(ix), #1
   2D77 DD 36 04 FF   [19]   72     ld      e_vx(ix), #0xFF
                             73 
   2D7B                      74 o_no_pulsada:
                             75     ;;ld      e_ai_aim_x(ix), #0
                             76 
   2D7B 21 03 08      [10]   77     ld      hl, #Key_P
   2D7E CD 35 5B      [17]   78     call    cpct_isKeyPressed_asm ;;tenemos que mandarle la tecla que queremos saber si esta pulsada
   2D81 28 14         [12]   79     jr      z, p_no_pulsada  ;;si me quiero mover a la derecha hay que sumar 1
   2D83 DD 7E 09      [19]   80     ld      a, e_ladder(ix)
   2D86 EE 01         [ 7]   81     xor     #e_ladder_up
   2D88 EE 02         [ 7]   82     xor     #e_ladder_down
   2D8A 28 0B         [12]   83     jr      z, p_no_pulsada
                             84     ;; Comprobamos que no tenga una entidad invisible a la derecha
   2D8C DD 7E 0A      [19]   85     ld      a, e_invisible(ix)
   2D8F EE 02         [ 7]   86     xor     #e_invisible_right
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 59.
Hexadecimal [16-Bits]



   2D91 28 04         [12]   87     jr      z, p_no_pulsada
                             88 
                             89     ;;ld      e_ai_aim_x(ix), #1
   2D93 DD 36 04 01   [19]   90     ld      e_vx(ix), #0x01
                             91 
   2D97                      92 p_no_pulsada:
                             93     ;;ld      e_ai_aim_x(ix), #0
                             94     
   2D97 21 08 08      [10]   95     ld      hl, #Key_Q
   2D9A CD 35 5B      [17]   96     call    cpct_isKeyPressed_asm ;;tenemos que mandarle la tecla que queremos saber si esta pulsada
   2D9D 28 13         [12]   97     jr      z, q_no_pulsada  ;;si quiero subir hay que restar -1
   2D9F DD 7E 09      [19]   98     ld      a, e_ladder(ix)
   2DA2 E6 01         [ 7]   99     and     #e_ladder_up
   2DA4 28 0C         [12]  100     jr      z, q_no_pulsada
   2DA6 DD 36 05 FF   [19]  101     ld      e_vy(ix), #-1
   2DAA DD 36 05 FE   [19]  102     ld      e_vy(ix), #0xFE
   2DAE DD 36 04 00   [19]  103     ld      e_vx(ix), #0x00
                            104 
   2DB2                     105 q_no_pulsada:
                            106 
   2DB2 21 08 20      [10]  107     ld      hl, #Key_A
   2DB5 CD 35 5B      [17]  108     call    cpct_isKeyPressed_asm ;;tenemos que mandarle la tecla que queremos saber si esta pulsada
   2DB8 28 13         [12]  109     jr      z, a_no_pulsada  ;;si quiero bajar hay que sumar 1
   2DBA DD 7E 09      [19]  110     ld      a, e_ladder(ix)
   2DBD E6 02         [ 7]  111     and     #e_ladder_down
   2DBF 28 0C         [12]  112     jr      z, a_no_pulsada
   2DC1 DD 36 05 01   [19]  113     ld      e_vy(ix), #1
   2DC5 DD 36 05 02   [19]  114     ld      e_vy(ix), #0x02
   2DC9 DD 36 04 00   [19]  115     ld      e_vx(ix), #0x00
                            116     
   2DCD                     117 a_no_pulsada:
                            118 
   2DCD DD 7E 05      [19]  119     ld      a, e_vy(ix)
   2DD0 EE FE         [ 7]  120     xor     #0xFE
   2DD2 28 42         [12]  121     jr      z, vely_negativa
   2DD4 DD 7E 05      [19]  122     ld      a, e_vy(ix)
   2DD7 EE 02         [ 7]  123     xor     #0x02
   2DD9 28 2A         [12]  124     jr      z, vely_positiva
                            125 
   2DDB DD 7E 04      [19]  126     ld      a, e_vx(ix)
   2DDE EE FF         [ 7]  127     xor     #0xFF
   2DE0 28 18         [12]  128     jr      z, velx_negativa
   2DE2 DD 7E 04      [19]  129     ld      a, e_vx(ix)
   2DE5 F6 00         [ 7]  130     or      #0x00
   2DE7 C8            [11]  131     ret     z
                            132 
   2DE8                     133 velx_positiva:
   2DE8 3E 50         [ 7]  134     ld      a, #80
   2DEA DD 96 06      [19]  135     sub     e_w(ix)
   2DED 47            [ 4]  136     ld      b, a
   2DEE DD 7E 02      [19]  137     ld      a, e_x(ix)
   2DF1 DD 86 04      [19]  138     add     e_vx(ix)
   2DF4 A8            [ 4]  139     xor     b 
   2DF5 CA 82 2E      [10]  140     jp      z, velxy_0
   2DF8 18 28         [12]  141     jr      sprite_delete
...
Hexadecimal [16-Bits]
                            ...
                            142     
                            143 
   2DFA                     144 velx_negativa:
   2DFA DD 7E 02      [19]  145     ld      a, e_x(ix)
   2DFD DD 86 04      [19]  146     add     e_vx(ix)
   2E00 CA 82 2E      [10]  147     jp      z, velxy_0
   2E03 18 1D         [12]  148     jr      sprite_delete
                            149 
   2E05                     150 vely_positiva:
   2E05 3E C9         [ 7]  151     ld      a, #0xC9        ;; 200 en hexadecimal
   2E07 DD 96 07      [19]  152     sub     e_h(ix)
   2E0A 47            [ 4]  153     ld      b, a
   2E0B DD 7E 03      [19]  154     ld      a, e_y(ix)
   2E0E DD 86 05      [19]  155     add     e_vy(ix)
   2E11 A8            [ 4]  156     xor     b 
   2E12 28 6E         [12]  157     jr      z, velxy_0
   2E14 18 0C         [12]  158     jr      sprite_delete
                            159 
   2E16                     160 vely_negativa:
   2E16 DD 7E 03      [19]  161     ld      a, e_y(ix)
   2E19 47            [ 4]  162     ld      b, a
   2E1A DD 86 05      [19]  163     add     e_vy(ix)
   2E1D 90            [ 4]  164     sub     b 
   2E1E 30 62         [12]  165     jr      nc, velxy_0
   2E20 18 00         [12]  166     jr      sprite_delete
                            167 
   2E22                     168 sprite_delete:
   2E22 CD 2F 30      [17]  169     call    update_XOR_borrar_IX
                            170 
   2E25                     171 sprite_up_down:
                            172 
   2E25 DD 7E 05      [19]  173     ld      a, e_vy(ix)
   2E28 D6 02         [ 7]  174     sub     #2
   2E2A 28 09         [12]  175     jr      z, sprite_inside_out
   2E2C DD 7E 05      [19]  176     ld      a, e_vy(ix)
   2E2F D6 FE         [ 7]  177     sub     #-2
   2E31 28 02         [12]  178     jr      z, sprite_inside_out
   2E33 18 0B         [12]  179     jr      sprite_right
                            180 
   2E35                     181 sprite_inside_out:
                            182 
   2E35 21 4D 0E      [10]  183     ld      hl, #_viking_sp_2
   2E38 DD 75 12      [19]  184     ld      e_sprite(ix), l
   2E3B DD 74 13      [19]  185     ld      e_sprite + 1(ix), h
                            186 
   2E3E 18 2E         [12]  187     jr      entity_move
                            188 
   2E40                     189 sprite_right:
                            190 
   2E40 DD 7E 04      [19]  191     ld      a, e_vx(ix)
   2E43 D6 01         [ 7]  192     sub     #1
   2E45 20 10         [12]  193     jr      nz, sprite_left
                            194 
   2E47 21 8D 0D      [10]  195     ld      hl, #_viking_sp_0
   2E4A DD 75 12      [19]  196     ld      e_sprite(ix), l
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 61.
Hexadecimal [16-Bits]



   2E4D DD 74 13      [19]  197     ld      e_sprite + 1(ix), h
                            198 
   2E50 3E 02         [ 7]  199     ld      a, #2
   2E52 32 46 2D      [13]  200     ld      (direccion_hammer), a
   2E55 18 17         [12]  201     jr      entity_move
                            202 
   2E57                     203 sprite_left:
                            204 
   2E57 DD 7E 04      [19]  205     ld      a, e_vx(ix)
   2E5A D6 FF         [ 7]  206     sub     #-1
   2E5C 20 10         [12]  207     jr      nz, entity_move
                            208 
   2E5E 21 ED 0D      [10]  209     ld      hl, #_viking_sp_1
   2E61 DD 75 12      [19]  210     ld      e_sprite(ix), l
   2E64 DD 74 13      [19]  211     ld      e_sprite + 1(ix), h
                            212 
   2E67 3E FE         [ 7]  213     ld      a, #-2
   2E69 32 46 2D      [13]  214     ld      (direccion_hammer), a
   2E6C 18 00         [12]  215     jr      entity_move
                            216 
   2E6E                     217 entity_move::
   2E6E DD 7E 02      [19]  218     ld      a, e_x(ix)
   2E71 DD 86 04      [19]  219     add     e_vx(ix)
   2E74 DD 77 02      [19]  220     ld      e_x(ix),a
                            221 
   2E77 DD 7E 03      [19]  222     ld      a, e_y(ix)
   2E7A DD 86 05      [19]  223     add     e_vy(ix)
   2E7D DD 77 03      [19]  224     ld      e_y(ix), a
                            225 
   2E80 18 00         [12]  226     jr      velxy_0
                            227 
   2E82                     228 velxy_0:
   2E82 DD 36 04 00   [19]  229     ld      e_vx(ix), #0
   2E86 DD 36 05 00   [19]  230     ld      e_vy(ix), #0
   2E8A C9            [10]  231     ret
                            232 
   2E8B                     233 move_hero_after_init:
   2E8B DD 7E 0B      [19]  234     ld      a, e_frame(ix)
   2E8E F6 FF         [ 7]  235     or      #e_frame_activo
   2E90 DD 77 0B      [19]  236     ld      e_frame(ix), a
   2E93 C9            [10]  237     ret
                            238 
                            239 ;;----------------------------------------------------------------------------
   2E94                     240 entity_enemy_move::
                            241 
   2E94 DD 7E 0B      [19]  242     ld      a, e_frame(ix)
   2E97 D6 FF         [ 7]  243     sub     #e_frame_activo
   2E99 20 58         [12]  244     jr      nz, next_frame_move
                            245 
   2E9B                     246 sprite_enemy_delete:
   2E9B CD 2F 30      [17]  247     call    update_XOR_borrar_IX
                            248 
   2E9E                     249 sprite_up_down_enemy:
                            250 
   2E9E DD 7E 05      [19]  251     ld      a, e_vy(ix)
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 62.
Hexadecimal [16-Bits]



   2EA1 D6 02         [ 7]  252     sub     #2
   2EA3 28 09         [12]  253     jr      z, sprite_inside_out_enemy
   2EA5 DD 7E 05      [19]  254     ld      a, e_vy(ix)
   2EA8 D6 FE         [ 7]  255     sub     #-2
   2EAA 28 02         [12]  256     jr      z, sprite_inside_out_enemy
   2EAC 18 0B         [12]  257     jr      sprite_right_enemy
                            258 
   2EAE                     259 sprite_inside_out_enemy:
                            260 
   2EAE 21 2D 0D      [10]  261     ld      hl, #_enemy_sp_2
   2EB1 DD 75 12      [19]  262     ld      e_sprite(ix), l
   2EB4 DD 74 13      [19]  263     ld      e_sprite + 1(ix), h
                            264 
   2EB7 18 22         [12]  265     jr      move_enemy
                            266 
   2EB9                     267 sprite_right_enemy:
                            268 
   2EB9 DD 7E 04      [19]  269     ld      a, e_vx(ix)
   2EBC D6 01         [ 7]  270     sub     #1
   2EBE 20 0B         [12]  271     jr      nz, sprite_left_enemy
                            272 
   2EC0 21 CD 0C      [10]  273     ld      hl, #_enemy_sp_1
   2EC3 DD 75 12      [19]  274     ld      e_sprite(ix), l
   2EC6 DD 74 13      [19]  275     ld      e_sprite + 1(ix), h
                            276 
   2EC9 18 10         [12]  277     jr      move_enemy
                            278 
   2ECB                     279 sprite_left_enemy:
                            280 
   2ECB DD 7E 04      [19]  281     ld      a, e_vx(ix)
   2ECE D6 FF         [ 7]  282     sub     #-1
   2ED0 20 09         [12]  283     jr      nz, move_enemy
                            284 
   2ED2 21 6D 0C      [10]  285     ld      hl, #_enemy_sp_0
   2ED5 DD 75 12      [19]  286     ld      e_sprite(ix), l
   2ED8 DD 74 13      [19]  287     ld      e_sprite + 1(ix), h
                            288 
   2EDB                     289 move_enemy::
                            290 
   2EDB DD 7E 02      [19]  291     ld      a, e_x(ix)
   2EDE DD 86 04      [19]  292     add     e_vx(ix)
   2EE1 DD 77 02      [19]  293     ld      e_x(ix), a
                            294 
   2EE4 DD 7E 03      [19]  295     ld      a, e_y(ix)
   2EE7 DD 86 05      [19]  296     add     e_vy(ix)
   2EEA DD 77 03      [19]  297     ld      e_y(ix), a
                            298 
   2EED 3E 01         [ 7]  299     ld      a, #e_frame_inactivo
   2EEF DD 77 0B      [19]  300     ld      e_frame(ix), a
                            301 
   2EF2 C9            [10]  302     ret
                            303 
   2EF3                     304 next_frame_move:
   2EF3 DD 7E 0B      [19]  305     ld      a, e_frame(ix)
   2EF6 F6 FF         [ 7]  306     or      #e_frame_activo
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 63.
Hexadecimal [16-Bits]



   2EF8 DD 77 0B      [19]  307     ld      e_frame(ix), a
   2EFB C9            [10]  308     ret
                            309 
                            310 ;;----------------------------------------------------------------------------
                            311 ;; IX --> Martillo a lanzar
                            312 ;; IY --> Hero
   2EFC                     313 entity_hammer_lado_move:
                            314 
   2EFC CD 36 32      [17]  315     call    man_entity_getEntity_hero_IY
                            316 
                            317     ;; Comprobamos que el hero no está en mitad de la escalera
   2EFF FD 7E 09      [19]  318     ld      a, e_ladder(iy)
   2F02 EE 01         [ 7]  319     xor     #e_ladder_up
   2F04 EE 02         [ 7]  320     xor     #e_ladder_down
   2F06 28 5B         [12]  321     jr      z, hammer_tiene_velocidad
                            322 
                            323     ;;call    cpct_scanKeyboard_asm ;;llamamos se escanea y ya
   2F08 21 05 80      [10]  324     ld      hl, #Key_Space
   2F0B CD 35 5B      [17]  325     call    cpct_isKeyPressed_asm ;;tenemos que mandarle la tecla que queremos saber si esta pulsada
   2F0E 28 53         [12]  326     jr      z, hammer_tiene_velocidad
                            327 
                            328     ;; Comprobamos que el hero tiene un martillo (hammer)
   2F10 FD 7E 01      [19]  329     ld      a, e_object(iy)
   2F13 E6 20         [ 7]  330     and     #e_object_hammer
   2F15 28 4C         [12]  331     jr      z, hammer_tiene_velocidad
                            332 
                            333     ;; Añadimos los parámetros a la entidad martillo (hammer) para que se lance delante 
   2F17 DD 7E 00      [19]  334     ld      a, e_type(ix)
   2F1A F6 04         [ 7]  335     or      #e_type_render
   2F1C DD 77 00      [19]  336     ld      e_type(ix), a
                            337 
   2F1F FD 7E 03      [19]  338     ld      a, e_y(iy)
   2F22 C6 04         [ 7]  339     add     #4
   2F24 DD 77 03      [19]  340     ld      e_y(ix), a
                            341 
   2F27 3A 46 2D      [13]  342     ld      a, (direccion_hammer)
   2F2A DD 77 04      [19]  343     ld      e_vx(ix), a
                            344 
   2F2D                     345 direccion_hammer_right:
                            346 
   2F2D DD 7E 04      [19]  347     ld      a, e_vx(ix)    
   2F30 D6 02         [ 7]  348     sub     #2
   2F32 20 13         [12]  349     jr      nz, direccion_hammer_left
                            350 
   2F34 21 05 0C      [10]  351     ld      hl, #_hammer_lado_sp_0
   2F37 DD 75 12      [19]  352     ld      e_sprite(ix), l
   2F3A DD 74 13      [19]  353     ld      e_sprite + 1(ix), h
                            354 
   2F3D FD 7E 02      [19]  355     ld      a, e_x(iy)
   2F40 C6 07         [ 7]  356     add     #7
   2F42 DD 77 02      [19]  357     ld      e_x(ix), a
                            358 
   2F45 18 11         [12]  359     jr      quitar_hammer
                            360 
   2F47                     361 direccion_hammer_left:
...
Hexadecimal [16-Bits]
                            ...
                            362 
   2F47 21 25 0C      [10]  363     ld      hl, #_hammer_lado_sp_1
   2F4A DD 75 12      [19]  364     ld      e_sprite(ix), l
   2F4D DD 74 13      [19]  365     ld      e_sprite + 1(ix), h
                            366     
   2F50 FD 7E 02      [19]  367     ld      a, e_x(iy)
   2F53 D6 03         [ 7]  368     sub     #3
   2F55 DD 77 02      [19]  369     ld      e_x(ix), a
                            370 
   2F58                     371 quitar_hammer:
                            372     ;; Le quitamos al hero el martillo (hammer)
   2F58 FD 7E 01      [19]  373     ld      a, e_object(iy)
   2F5B D6 20         [ 7]  374     sub     #e_object_hammer
   2F5D FD 77 01      [19]  375     ld      e_object(iy), a
                            376 
                            377     ;; Pintamos con el OR el martillo para que cuando se use el XOR se borre la primera vez
   2F60 CD FF 2F      [17]  378     call    sys_render_update
                            379 
                            380 ;; Comprobamos que tenga velocidad
   2F63                     381 hammer_tiene_velocidad:
   2F63 DD 7E 04      [19]  382     ld      a, e_vx(ix)
   2F66 FE 02         [ 7]  383     cp      #0x02
   2F68 28 0C         [12]  384     jr      z, vx_positiva_hammer
   2F6A FE FE         [ 7]  385     cp      #0xFE
   2F6C C0            [11]  386     ret     nz
                            387 
                            388 ;; Comprobamos que al avanzar no se sale de la pantalla
   2F6D                     389 vx_negativa_hammer:
   2F6D DD 7E 02      [19]  390     ld      a, e_x(ix)
   2F70 D6 03         [ 7]  391     sub     #3
   2F72 38 1B         [12]  392     jr      c, restablecer_hammer
   2F74 18 0C         [12]  393     jr      sprite_hammer_delete
                            394 
   2F76                     395 vx_positiva_hammer:
   2F76 DD 7E 02      [19]  396     ld      a, e_x(ix)
   2F79 DD 86 06      [19]  397     add     e_w(ix)
   2F7C 47            [ 4]  398     ld      b, a
   2F7D 3E 4C         [ 7]  399     ld      a, #76
   2F7F 90            [ 4]  400     sub     b
   2F80 38 0D         [12]  401     jr      c, restablecer_hammer
                            402 
                            403 ;; Borramos en la posición actual el martillo para pintar en la siguiente
   2F82                     404 sprite_hammer_delete:
   2F82 CD 2F 30      [17]  405     call    update_XOR_borrar_IX
                            406 
                            407 ;; Movemos el martillo (hammer)
   2F85                     408 move_hammer::
   2F85 DD 7E 02      [19]  409     ld      a, e_x(ix)
   2F88 DD 86 04      [19]  410     add     e_vx(ix)
   2F8B DD 77 02      [19]  411     ld      e_x(ix),a
                            412 
   2F8E C9            [10]  413     ret
                            414 
                            415 ;; Reestablecemos las características de la entidad martillo (hammer)
   2F8F                     416 restablecer_hammer:
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 65.
Hexadecimal [16-Bits]



   2F8F CD 2F 30      [17]  417     call    update_XOR_borrar_IX
   2F92 DD 36 02 02   [19]  418     ld      e_x(ix), #0x02
   2F96 DD 36 03 02   [19]  419     ld      e_y(ix), #0x02
   2F9A DD 36 04 00   [19]  420     ld      e_vx(ix), #0x00
   2F9E DD 7E 00      [19]  421     ld      a, e_type(ix)
   2FA1 EE 04         [ 7]  422     xor     #e_type_render      ;; También se podría eliminar con sub
   2FA3 DD 77 00      [19]  423     ld      e_type(ix), a
                            424 
   2FA6 C9            [10]  425     ret
                            426 ;;----------------------------------------------------------------------------
   2FA7                     427 entity_nothing::
                            428 
   2FA7 C9            [10]  429     ret  
