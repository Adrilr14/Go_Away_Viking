...
Hexadecimal [16-Bits]
                             ...
                             36 
                             37 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             38 ;;SYS COLLISION: Update
                             39 ;;          Check collisions between all Entity collision bodies
                             40 ;;INPUT:
                             41 ;;      IX --> Puntero a la primera entidad de la pareja
                             42 ;;      IY --> Puntero a la segunda entidad de la pareja
                             43 ;;DESTROYS:
                             44 ;;
   2A80                      45 sys_collision_update::
                             46 
   2A80                      47 collision_primero_segundo:
                             48 
   2A80 DD 7E 08      [19]   49     ld      a, e_collisionable(ix)
   2A83 FD 46 01      [19]   50     ld      b, e_object(iy)
   2A86 A0            [ 4]   51     and     b
   2A87 47            [ 4]   52     ld      b, a
   2A88 20 09         [12]   53     jr      nz, sys_collision_check       
                             54 
   2A8A                      55 collision_segundo_primero:
                             56 
   2A8A FD 7E 08      [19]   57     ld      a, e_collisionable(iy)
   2A8D DD 46 01      [19]   58     ld      b, e_object(ix)
   2A90 A0            [ 4]   59     and     b
   2A91 47            [ 4]   60     ld      b, a
   2A92 C8            [11]   61     ret     z
                             62 
   2A93                      63 sys_collision_check:
   2A93 3E 02         [ 7]   64     ld      a, #e_object_enemy
   2A95 A0            [ 4]   65     and     b
   2A96 20 1C         [12]   66     jr      nz, collision_with_enemy_or_invisible_or_key_or_hammer
                             67 
   2A98 3E 10         [ 7]   68     ld      a, #e_object_invisible
   2A9A A0            [ 4]   69     and     b
   2A9B 20 17         [12]   70     jr      nz, collision_with_enemy_or_invisible_or_key_or_hammer
                             71 
   2A9D 3E 40         [ 7]   72     ld      a, #e_object_key
   2A9F A0            [ 4]   73     and     b
   2AA0 20 12         [12]   74     jr      nz, collision_with_enemy_or_invisible_or_key_or_hammer
                             75 
   2AA2 3E 20         [ 7]   76     ld      a, #e_object_hammer
   2AA4 A0            [ 4]   77     and     b
   2AA5 20 0D         [12]   78     jr      nz, collision_with_enemy_or_invisible_or_key_or_hammer
                             79 
   2AA7 3E 08         [ 7]   80     ld      a, #e_object_door
   2AA9 A0            [ 4]   81     and     b
   2AAA C2 C9 2B      [10]   82     jp      nz, collision_with_door
                             83 
   2AAD 3E 04         [ 7]   84     ld      a, #e_object_ladder
...
Hexadecimal [16-Bits]
   ...
   2AAF A0            [ 4]   85     and     b
   2AB0 C2 F0 2B      [10]   86     jp      nz, collision_with_ladder
                             87 
   2AB3 C9            [10]   88     ret
                             89 ;;-----------------------------------------------------------------------------------
                             90 ;; Colisión con una entidad enemigo o invisible
   2AB4                      91 collision_with_enemy_or_invisible_or_key_or_hammer:
                             92     ;;EJE X
                             93     ;; if (A < B) no_collision
                             94     ;; if (e_x(ix) + e_w(ix) < e_x(iy))   no_collision
                             95     ;; if (e_x(ix) + e_w(ix) - e_x(iy) < 0)   no_collision
                             96     ;; Si en un eje no colisiona es que estan separados
                             97 
   2AB4 DD 7E 02      [19]   98     ld      a, e_x(ix)
   2AB7 DD 86 06      [19]   99     add     e_w(ix)
   2ABA FD 96 02      [19]  100     sub     e_x(iy)
   2ABD DA 2A 2B      [10]  101     jp      c, no_collision                        ;; m es minus (que sea negativo)
                            102 
                            103 
                            104     ;; if (C < D) no_collision
                            105     ;; if (e_x(iy) + e_w(iy) < e_x(ix))   no_collision
                            106     ;; if (e_x(iy) + e_w(iy) - e_x(ix) < 0)   no_collision
   2AC0 FD 7E 02      [19]  107     ld      a, e_x(iy)
   2AC3 FD 86 06      [19]  108     add     e_w(iy)
   2AC6 DD 96 02      [19]  109     sub     e_x(ix)
   2AC9 38 5F         [12]  110     jr      c, no_collision                        ;; m es minus (que sea negativo), p es positive
                            111     
                            112     ;;EJE Y
                            113     ;; if (e_y(ix) + e_h(ix) - e_y(iy) < 0)   no_collision
   2ACB DD 7E 03      [19]  114     ld      a, e_y(ix)
   2ACE DD 86 07      [19]  115     add     e_h(ix)
   2AD1 FD 96 03      [19]  116     sub     e_y(iy)
   2AD4 38 54         [12]  117     jr      c, no_collision 
                            118 
                            119 
                            120     ;; if (e_y(iy) + e_h(iy) - e_y(ix) < 0)   no_collision
   2AD6 FD 7E 03      [19]  121     ld      a, e_y(iy)
   2AD9 FD 86 07      [19]  122     add     e_h(iy)
   2ADC DD 96 03      [19]  123     sub     e_y(ix)
   2ADF 38 49         [12]  124     jr      c, no_collision
                            125 
                            126     ;; Comprobamos si la colisión es con un enemigo
   2AE1 3E 02         [ 7]  127     ld      a, #e_object_enemy
   2AE3 A0            [ 4]  128     and     b
   2AE4 20 39         [12]  129     jr      nz, collision_with_enemy
                            130 
                            131     ;; Comprobamos si la colisión es con una llave (key)
   2AE6 3E 40         [ 7]  132     ld      a, #e_object_key
   2AE8 A0            [ 4]  133     and     b
   2AE9 C2 6F 2B      [10]  134     jp      nz, collision_with_key
                            135 
                            136     ;; Comprobamos si la colisión es con una martillo (hammer)
   2AEC 3E 20         [ 7]  137     ld      a, #e_object_hammer
   2AEE A0            [ 4]  138     and     b
   2AEF C2 85 2B      [10]  139     jp      nz, collision_with_hammer
...
Hexadecimal [16-Bits]
                            ...
                            140 
                            141 ;;-----------------------------------------------------------------------------------
                            142 ;; Collision con una entidad invisible
   2AF2                     143 collision_with_invisible:
                            144     ;;ld      a, e_object(ix)
                            145     ;;and     #e_object_enemy
                            146     ;;jr      nz, update_enemy_after_collision_ix_invisible
                            147 ;;
                            148     ;;ld      a, e_object(iy)
                            149     ;;and     #e_object_enemy
                            150     ;;jr      nz, update_enemy_after_collision_iy_invisible
                            151 
   2AF2 DD 7E 01      [19]  152     ld      a, e_object(ix)
   2AF5 E6 01         [ 7]  153     and     #e_object_hero
   2AF7 20 00         [12]  154     jr      nz, update_hero_after_collision_ix_invisible
                            155 
                            156 ;;update_hero_after_collision_iy_invisible:
                            157 ;;
                            158 ;;    ld      e_type(iy), #0x0E
                            159 ;;    ret
                            160 
   2AF9                     161 update_hero_after_collision_ix_invisible:
                            162 
                            163 ;; Comprobamos si la entidad invisible está a la izquierda (left)
   2AF9                     164 collision_with_invisible_left:
   2AF9 DD 7E 02      [19]  165     ld      a, e_x(ix)
   2AFC D6 01         [ 7]  166     sub     #1          ;; Así se comprueba si está al lado
   2AFE FD AE 02      [19]  167     xor     e_x(iy)
   2B01 20 09         [12]  168     jr      nz, collision_with_invisible_right
                            169 
                            170     ;; Le añadimos la máscara del tipo e_type_invisible_left para que no pueda ir hacia la izquierda
   2B03 DD 7E 0A      [19]  171     ld      a, e_invisible(ix)
   2B06 F6 01         [ 7]  172     or      #e_invisible_left
   2B08 DD 77 0A      [19]  173     ld      e_invisible(ix), a
                            174 
   2B0B C9            [10]  175     ret
                            176 
                            177 ;; Comprobamos si la entidad invisible está a la derecha (right)
   2B0C                     178 collision_with_invisible_right:
   2B0C DD 7E 02      [19]  179     ld      a, e_x(ix)
   2B0F DD 86 06      [19]  180     add     e_w(ix)     ;; Si la colisión es en la derecha se le añade el ancho (width) a la posición del hero
                            181     ;;add     #1          ;; Así se comprueba si está al lado
   2B12 FD AE 02      [19]  182     xor     e_x(iy)
   2B15 C0            [11]  183     ret     nz
                            184 
                            185     ;; Le añadimos la máscara del tipo e_type_invisible_right para que no pueda ir hacia la izquierda
   2B16 DD 7E 0A      [19]  186     ld      a, e_invisible(ix)
   2B19 F6 02         [ 7]  187     or      #e_invisible_right
   2B1B DD 77 0A      [19]  188     ld      e_invisible(ix), a
                            189 
   2B1E C9            [10]  190     ret
                            191 
                            192 ;;update_enemy_after_collision_iy_invisible:
                            193 ;;    
                            194 ;;    ld      e_vx(iy), #-1
...
Hexadecimal [16-Bits]
                            ...
                            195 ;;    ret
                            196 ;;
                            197 ;;update_enemy_after_collision_ix_invisible:
                            198 ;;
                            199 ;;    ld      e_vx(ix), #-1
                            200 ;;    ret
                            201 
                            202 ;;-----------------------------------------------------------------------------------
                            203 ;; Collision con una entidad enemigo
   2B1F                     204 collision_with_enemy:
   2B1F DD 7E 01      [19]  205     ld      a, e_object(ix)
   2B22 E6 01         [ 7]  206     and     #e_object_hero
   2B24 20 00         [12]  207     jr      nz, update_hero_after_collision_ix
                            208 
                            209 ;;update_hero_after_collision_iy:
                            210 ;;    ;;ld__e_iyl
                            211 ;;    ;;ld__d_iyh
                            212 ;;    ld      b, #0x01
                            213 ;;    ;;call    update_XOR_after_hero_collision
                            214 ;;    ld      e_x(iy), #0x00
                            215 ;;    ld      e_y(iy), #0xA4
                            216 ;;    ret
                            217 
   2B26                     218 update_hero_after_collision_ix:
                            219     ;; MUERE AQUI
                            220     ;;call    man_entity_destroy
   2B26 CD CD 54      [17]  221     call    man_menu_lose
                            222     ;;ld__e_ixl
                            223     ;;ld__d_ixh
                            224     ;;ld      b, #0x00
                            225     ;;call    update_XOR_after_hero_collision
                            226     ;;ld      e_x(ix), #0x00
                            227     ;;ld      e_y(ix), #0xA4
   2B29 C9            [10]  228     ret
                            229 
                            230 ;;-----------------------------------------------------------------------------------
                            231 ;; No hay collision
   2B2A                     232 no_collision:
                            233     ;; Comprobamos si la colisión es con una entidad invisible
   2B2A 3E 10         [ 7]  234     ld      a, #e_object_invisible
   2B2C A0            [ 4]  235     and     b
   2B2D C8            [11]  236     ret     z 
                            237 
                            238     ;; Comprobamos si el que colisiona es un hero y no el enemigo
   2B2E DD 7E 01      [19]  239     ld      a, e_object(ix)
   2B31 E6 01         [ 7]  240     and     #e_object_hero
   2B33 C8            [11]  241     ret     z
                            242 
   2B34 DD 7E 03      [19]  243     ld      a, e_y(ix)
   2B37 FD AE 03      [19]  244     xor     e_y(iy)
   2B3A C0            [11]  245     ret     nz
                            246     
                            247 ;; Comprobamos si hay una entidad invisible con la que choca el hero en x
                            248 
                            249     ;;ld__e_iyl
...
Hexadecimal [16-Bits]
                            ...
                            250     ;;ld__d_iyh
                            251 ;;
                            252     ;;ld      hl, #comprobar_invisible_x
                            253     ;;ld      a, #e_object_invisible
                            254     ;;call    man_entity_ladder_invisible_matching
                            255 ;;
                            256     ;;ld__iyl_e
                            257     ;;ld__iyh_d
                            258 ;;
                            259     ;;ld      a, e_invisible(ix)
                            260     ;;xor     #e_invisible_collision
                            261     ;;jr      z, hay_otra_invisible_x
                            262 ;;
                            263     ;;;;ld      e_ladder(ix), #e_ladder_nothing
                            264     ;;;;jr      ladder_misma_y
                            265     ;;jr      no_collision_left_invisible
                            266 ;;
                            267     ;;ret
                            268 ;;comprobar_invisible_x:
                            269 ;;
                            270 ;;    ld      a, e_x(ix)
                            271 ;;    sub     #1          ;; Así se comprueba si está al lado
                            272 ;;    xor     e_x(iy)
                            273 ;;    jr      z, golpe_invisible
                            274 ;;
                            275 ;;    ld      a, e_x(ix)
                            276 ;;    add     e_w(ix)     ;; Si la colisión es en la derecha se le añade el ancho (width) a la posición del hero
                            277 ;;    ;;add     #1          ;; Así se comprueba si está al lado
                            278 ;;    xor     e_x(iy)
                            279 ;;    jr      z, golpe_invisible
                            280 ;;    ret   
                            281 
                            282 ;;golpe_invisible:
                            283 ;;
                            ...
                            286 ;;    ret     nz  
                            287 ;;
                            288 ;;    ld      a, e_invisible(ix)
                            289 ;;    or      #e_invisible_collision
                            290 ;;    ld      e_invisible(ix), a
                            291 ;;    ret
                            292 
                            293 ;;hay_otra_invisible_x:
                            294 ;;
                            295 ;;    ld      a, e_invisible(ix)
                            296 ;;    xor     #e_invisible_collision
                            297 ;;    ret     nz
                            298 ;;
                            299 ;;    ld      a, e_invisible(ix)
                            300 ;;    sub     #e_invisible_collision
                            301 ;;    ld      e_invisible(ix), a
                            302 ;;    ret
                            303 
   2B3B                     304 no_collision_left_invisible:
...
Hexadecimal [16-Bits]
                            ...
                            305 
   2B3B DD 7E 02      [19]  306     ld      a, e_x(ix)
   2B3E D6 02         [ 7]  307     sub     #2          ;; Así se comprueba si está al lado
   2B40 FD AE 02      [19]  308     xor     e_x(iy)
   2B43 20 0F         [12]  309     jr      nz, no_collision_right_invisible
                            310 
   2B45 DD 7E 0A      [19]  311     ld      a, e_invisible(ix)
   2B48 E6 01         [ 7]  312     and     #e_invisible_left
   2B4A 28 08         [12]  313     jr      z, no_collision_right_invisible
                            314 
   2B4C DD 7E 0A      [19]  315     ld      a, e_invisible(ix)
   2B4F D6 01         [ 7]  316     sub     #e_invisible_left
   2B51 DD 77 0A      [19]  317     ld      e_invisible(ix), a
                            318 
   2B54                     319 no_collision_right_invisible:
                            320 
   2B54 DD 7E 02      [19]  321     ld      a, e_x(ix)
   2B57 DD 86 06      [19]  322     add     e_w(ix)     ;; Si la colisión es en la derecha se le añade el ancho (width) a la posición del hero
   2B5A C6 01         [ 7]  323     add     #1          ;; Así se comprueba si está al lado
   2B5C FD AE 02      [19]  324     xor     e_x(iy)
   2B5F C0            [11]  325     ret     nz
                            326 
   2B60 DD 7E 0A      [19]  327     ld      a, e_invisible(ix)
   2B63 E6 02         [ 7]  328     and     #e_invisible_right
   2B65 C8            [11]  329     ret     z
                            330 
   2B66 DD 7E 0A      [19]  331     ld      a, e_invisible(ix)
   2B69 D6 02         [ 7]  332     sub     #e_invisible_right
   2B6B DD 77 0A      [19]  333     ld      e_invisible(ix), a
                            334 
   2B6E C9            [10]  335     ret
                            336 
                            337 ;;-----------------------------------------------------------------------------------
                            338 ;; Collision con una entidad llave (key)
   2B6F                     339 collision_with_key:
                            340     ;; Se le añade al hero el object key para que así pueda salir por la puerta del nivel
   2B6F DD 7E 01      [19]  341     ld      a, e_object(ix)
   2B72 E6 40         [ 7]  342     and     #e_object_key
   2B74 C0            [11]  343     ret     nz
                            344 
   2B75 DD 7E 01      [19]  345     ld      a, e_object(ix)
   2B78 F6 40         [ 7]  346     or      #e_object_key
   2B7A DD 77 01      [19]  347     ld      e_object(ix), a
                            348 
                            349     ;; Se hace desaparecer la llave eliminando el e_type_render y e_type_collision (para que no vuelva a colisionar)
                            350     ;;ld      a, e_type(iy)
                            351     ;;and     #e_type_render
                            352     ;;ret     z
                            353 ;;
                            354     ;;ld      a, e_type(iy)
                            355     ;;sub     #e_type_render
                            356     ;;ld      e_type(iy), a
   2B7D FD 36 00 20   [19]  357     ld      e_type(iy), #e_type_none
   2B81 CD 51 30      [17]  358     call    update_XOR_borrar_IY
                            359 
...
Hexadecimal [16-Bits]
   ...
   2B84 C9            [10]  360     ret
                            361 
                            362 ;;-----------------------------------------------------------------------------------
                            363 ;; Collision con una entidad martillo (hammer)
   2B85                     364 collision_with_hammer:
                            365 ;; Comprobamos si la colisión es con el hero
   2B85 DD 7E 01      [19]  366     ld      a, e_object(ix)
   2B88 E6 01         [ 7]  367     and     #e_object_hero
   2B8A 20 23         [12]  368     jr      nz, collision_with_hammer_hero
                            369 
                            370 ;; El martillo (hammer) golpea al enemigo
   2B8C                     371 collision_with_hammer_enemy:
                            372     ;; Borra y reestablece el martillo (hammer)
   2B8C CD 51 30      [17]  373     call    update_XOR_borrar_IY
   2B8F FD 36 02 02   [19]  374     ld      e_x(iy), #0x02
   2B93 FD 36 03 02   [19]  375     ld      e_y(iy), #0x02
   2B97 FD 36 04 00   [19]  376     ld      e_vx(iy), #0x00
   2B9B FD 7E 00      [19]  377     ld      a, e_type(iy)
   2B9E EE 04         [ 7]  378     xor     #e_type_render      ;; También se podría eliminar con sub
   2BA0 FD 77 00      [19]  379     ld      e_type(iy), a
                            380 
                            381     ;; Borra al enemigo y se le pone e_type_none y e_object_none
                            382 
   2BA3 CD 2F 30      [17]  383     call    update_XOR_borrar_IX
   2BA6 DD 36 00 20   [19]  384     ld      e_type(ix), #e_type_none
   2BAA DD 36 01 00   [19]  385     ld      e_object(ix), #e_object_none
                            386 
   2BAE C9            [10]  387     ret
                            388 
                            389 ;; El hero coge el martillo (hammer)
   2BAF                     390 collision_with_hammer_hero:
                            391     ;; Se le añade al hero el object hammer para que así pueda salir por la puerta del nivel (solo si no lo tiene añadido ya)
   2BAF DD 7E 01      [19]  392     ld      a, e_object(ix)
   2BB2 E6 20         [ 7]  393     and     #e_object_hammer
   2BB4 C0            [11]  394     ret     nz
                            395 
   2BB5 DD 7E 01      [19]  396     ld      a, e_object(ix)
   2BB8 F6 20         [ 7]  397     or      #e_object_hammer
   2BBA DD 77 01      [19]  398     ld      e_object(ix), a
                            399 
                            400     ;; Se convierte el martillo (hammer) en un e_object_none
   2BBD FD 36 01 00   [19]  401     ld      e_object(iy), #e_object_none
                            402 
                            403     ;; Se hace desaparecer el martillo (hammer) eliminando el e_type_render
   2BC1 FD 36 00 20   [19]  404     ld      e_type(iy), #e_type_none
   2BC5 CD 51 30      [17]  405     call    update_XOR_borrar_IY
                            406 
   2BC8 C9            [10]  407     ret
                            408 
                            409 ;;-----------------------------------------------------------------------------------
                            410 ;; Collision con una entidad puerta (door)
   2BC9                     411 collision_with_door:
                            412 ;; Comprobamos que el hero tiene la llave (key)
   2BC9 DD 7E 01      [19]  413     ld      a, e_object(ix)
   2BCC E6 40         [ 7]  414     and     #e_object_key
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 68.
Hexadecimal [16-Bits]



   2BCE C8            [11]  415     ret     z
                            416 
                            417 ;; Comprobamos que la X sea igual para que estén en la misma posición
   2BCF DD 7E 02      [19]  418     ld      a, e_x(ix)
   2BD2 FD AE 02      [19]  419     xor     e_x(iy)
   2BD5 C2 2A 2B      [10]  420     jp      nz, no_collision
                            421 
                            422 ;; Comprobamos que la Y sea igual para que estén en la misma posición
   2BD8 DD 7E 03      [19]  423     ld      a, e_y(ix)
   2BDB FD AE 03      [19]  424     xor     e_y(iy)
   2BDE C2 2A 2B      [10]  425     jp      nz, no_collision
                            426 
                            427 ;; Si llega AQUI es que ha entrado por la puerta y pasado de nivel
                            428 
   2BE1 3A A5 52      [13]  429     ld      a, (num_level)
   2BE4 D6 14         [ 7]  430     sub     #20
   2BE6 28 04         [12]  431     jr      z, call_finish_game
                            432 
   2BE8 CD BF 56      [17]  433     call    man_menu_level_completed
                            434     
   2BEB C9            [10]  435     ret
                            436 
   2BEC                     437 call_finish_game:
   2BEC CD 3C 57      [17]  438     call    man_menu_finish
   2BEF C9            [10]  439     ret
                            440 
                            441 ;;-----------------------------------------------------------------------------------
                            442 ;; Collision con una entidad escalera (ladder)
   2BF0                     443 collision_with_ladder:
                            444 ;; Comprobamos que la X sea igual para que estén en la misma posición
   2BF0 DD 7E 02      [19]  445     ld      a, e_x(ix)
   2BF3 FD AE 02      [19]  446     xor     e_x(iy)
   2BF6 20 39         [12]  447     jr      nz, no_collision_ladder
                            448 
                            449 ;; Comprobamos si el hero está en IX o en IY
   2BF8 DD 7E 01      [19]  450     ld      a, e_object(ix)
   2BFB E6 01         [ 7]  451     and     #e_object_hero
   2BFD 20 00         [12]  452     jr      nz, hero_move_up_down_ix
                            453 
   2BFF                     454 hero_move_up_down_ix:
   2BFF DD 7E 09      [19]  455     ld      a, e_ladder(ix)
   2C02 F6 01         [ 7]  456     or      #e_ladder_up
   2C04 F6 02         [ 7]  457     or      #e_ladder_down
   2C06 DD 77 09      [19]  458     ld      e_ladder(ix), a
   2C09 18 00         [12]  459     jr      comprobar_ladder_y_up
                            460 
                            461 
                            462 ;; Hacemos comprobaciones en la Y para evitar que suba más de la escalera y baje más de la misma
   2C0B                     463 comprobar_ladder_y_up:
                            464 
   2C0B FD 7E 03      [19]  465     ld      a, e_y(iy)
   2C0E FD 96 07      [19]  466     sub     e_h(iy)
                            467     ;sub     e_h(ix)
   2C11 DD 46 03      [19]  468     ld      b, e_y(ix)   
   2C14 90            [ 4]  469     sub     b
...
Hexadecimal [16-Bits]
   ...
   2C15 D2 15 2D      [10]  470     jp      nc, no_collision_ladder_up
                            471 
   2C18 FD 7E 03      [19]  472     ld      a, e_y(iy)
   2C1B C6 01         [ 7]  473     add     #0x01
   2C1D 47            [ 4]  474     ld      b, a
   2C1E DD 7E 03      [19]  475     ld      a, e_y(ix)
   2C21 90            [ 4]  476     sub     b
   2C22 D2 15 2D      [10]  477     jp      nc, no_collision_ladder_up
                            478     
                            479     ;;ret
                            480 
   2C25                     481 comprobar_ladder_y_down:
   2C25 FD 7E 03      [19]  482     ld      a, e_y(iy)
   2C28 47            [ 4]  483     ld      b, a  
   2C29 DD 7E 03      [19]  484     ld      a, e_y(ix)
   2C2C 90            [ 4]  485     sub     b
   2C2D D2 30 2D      [10]  486     jp      nc, no_collision_ladder_down
                            487 
   2C30 C9            [10]  488     ret
                            489 
                            490 ;;-----------------------------------------------------------------------------------
                            491 ;; No hay collision con ladder
   2C31                     492 no_collision_ladder:
                            493 
   2C31 DD 7E 01      [19]  494     ld      a, e_object(ix)
   2C34 E6 01         [ 7]  495     and     #e_object_hero
   2C36 20 00         [12]  496     jr      nz, no_collision_ladder_ix
                            497 
   2C38                     498 no_collision_ladder_ix:
                            499 
   2C38 DD 7E 03      [19]  500     ld      a, e_y(ix)
   2C3B FD AE 03      [19]  501     xor     e_y(iy)
   2C3E 20 6F         [12]  502     jr      nz, no_down_without_more_ladders
                            503 
                            504 ;; Comprobamos si hay escaleras en la misma x
                            505 
   01C0                     506     ld__e_iyl
   2C40 FD 5D                 1    .dw #0x5DFD  ;; Opcode for ld e, iyl
   01C2                     507     ld__d_iyh
   2C42 FD 54                 1    .dw #0x54FD  ;; Opcode for ld d, iyh
                            508 
   2C44 21 5A 2C      [10]  509     ld      hl, #comprobar_otras_x
   2C47 3E 04         [ 7]  510     ld      a, #e_object_ladder
   2C49 CD F9 33      [17]  511     call    man_entity_ladder_invisible_matching
                            512 
   01CC                     513     ld__iyl_e
   2C4C FD 6B                 1    .dw #0x6BFD  ;; Opcode for ld iyl, e
   01CE                     514     ld__iyh_d
   2C4E FD 62                 1    .dw #0x62FD  ;; Opcode for ld iyh, d
                            515 
   2C50 DD 7E 09      [19]  516     ld      a, e_ladder(ix)
   2C53 EE 04         [ 7]  517     xor     #e_ladder_dentro
   2C55 28 1F         [12]  518     jr      z, permitir_bajar
                            519 
   2C57 18 22         [12]  520     jr      ladder_misma_y
...
Hexadecimal [16-Bits]
   ...
   2C59 C9            [10]  522     ret
                            523 
   2C5A                     524 comprobar_otras_x:
   2C5A DD 7E 02      [19]  525     ld      a, e_x(ix)
   2C5D FD AE 02      [19]  526     xor     e_x(iy)
   2C60 C0            [11]  527     ret     nz
                            528 
   2C61 DD 7E 03      [19]  529     ld      a, e_y(ix)
   2C64 EE A4         [ 7]  530     xor     #0xA4
   2C66 C8            [11]  531     ret     z
                            532 
                            533     ;; Conprobamos que tenga debajo una escalera
   2C67 DD 7E 03      [19]  534     ld      a, e_y(ix)
   2C6A FD 86 07      [19]  535     add     e_h(iy)
   2C6D FD 96 03      [19]  536     sub     e_y(iy)
   2C70 C0            [11]  537     ret     nz
                            538 
   2C71 DD 36 09 04   [19]  539     ld      e_ladder(ix), #e_ladder_dentro
   2C75 C9            [10]  540     ret
                            541 
   2C76                     542 permitir_bajar:
                            543 
   2C76 DD 36 09 02   [19]  544     ld      e_ladder(ix), #e_ladder_down
   2C7A C9            [10]  545     ret
                            546 
                            547 ;; Comprobamos si hay escaleras en la misma y
   2C7B                     548 ladder_misma_y:
                            549 
   01FB                     550     ld__e_iyl
   2C7B FD 5D                 1    .dw #0x5DFD  ;; Opcode for ld e, iyl
   01FD                     551     ld__d_iyh
   2C7D FD 54                 1    .dw #0x54FD  ;; Opcode for ld d, iyh
                            552 
   2C7F 21 97 2C      [10]  553     ld      hl, #comprobar_otras_y
   2C82 3E 04         [ 7]  554     ld      a, #e_object_ladder
   2C84 CD F9 33      [17]  555     call    man_entity_ladder_invisible_matching
                            556 
   0207                     557     ld__iyl_e
   2C87 FD 6B                 1    .dw #0x6BFD  ;; Opcode for ld iyl, e
   0209                     558     ld__iyh_d
   2C89 FD 62                 1    .dw #0x62FD  ;; Opcode for ld iyh, d
                            559 
   2C8B DD 7E 09      [19]  560     ld      a, e_ladder(ix)
   2C8E EE 04         [ 7]  561     xor     #e_ladder_dentro
   2C90 28 18         [12]  562     jr      z, permitir_subir
                            563 
   2C92 DD 36 09 00   [19]  564     ld      e_ladder(ix), #e_ladder_nothing
                            565 
   2C96 C9            [10]  566     ret
                            567 
   2C97                     568 comprobar_otras_y:
   2C97 DD 7E 03      [19]  569     ld      a, e_y(ix)
   2C9A FD AE 03      [19]  570     xor     e_y(iy)
   2C9D C0            [11]  571     ret     nz
...
Hexadecimal [16-Bits]
                            ...
                            572 
   2C9E DD 7E 02      [19]  573     ld      a, e_x(ix)
   2CA1 FD AE 02      [19]  574     xor     e_x(iy)
   2CA4 C0            [11]  575     ret     nz
                            576 
   2CA5 DD 36 09 04   [19]  577     ld      e_ladder(ix), #e_ladder_dentro
   2CA9 C9            [10]  578     ret
                            579 
   2CAA                     580 permitir_subir:
                            581 
   2CAA DD 36 09 01   [19]  582     ld      e_ladder(ix), #e_ladder_up
   2CAE C9            [10]  583     ret
                            584 
   2CAF                     585 no_down_without_more_ladders:
                            586 
                            587 ;; Comprobamos si hay escaleras en la misma x
                            588 
   022F                     589     ld__e_iyl
   2CAF FD 5D                 1    .dw #0x5DFD  ;; Opcode for ld e, iyl
   0231                     590     ld__d_iyh
   2CB1 FD 54                 1    .dw #0x54FD  ;; Opcode for ld d, iyh
                            591 
   2CB3 21 C9 2C      [10]  592     ld      hl, #comprobar_mas_x
   2CB6 3E 04         [ 7]  593     ld      a, #e_object_ladder
   2CB8 CD F9 33      [17]  594     call    man_entity_ladder_invisible_matching
                            595 
   023B                     596     ld__iyl_e
   2CBB FD 6B                 1    .dw #0x6BFD  ;; Opcode for ld iyl, e
   023D                     597     ld__iyh_d
   2CBD FD 62                 1    .dw #0x62FD  ;; Opcode for ld iyh, d
                            598 
   2CBF DD 7E 09      [19]  599     ld      a, e_ladder(ix)
   2CC2 E6 04         [ 7]  600     and     #e_ladder_dentro
   2CC4 20 23         [12]  601     jr      nz, permitir_bajar_mas_x
                            602 
                            603     ;;ld      e_ladder(ix), #e_ladder_nothing
   2CC6 18 32         [12]  604     jr      no_more_ladders_x
                            605 
   2CC8 C9            [10]  606     ret
                            607 
   2CC9                     608 comprobar_mas_x:
   2CC9 DD 7E 02      [19]  609     ld      a, e_x(ix)
   2CCC FD AE 02      [19]  610     xor     e_x(iy)
   2CCF C0            [11]  611     ret     nz
                            612 
   2CD0 DD 7E 03      [19]  613     ld      a, e_y(ix)
   2CD3 EE A4         [ 7]  614     xor     #0xA4
   2CD5 C8            [11]  615     ret     z
                            616 
                            617     ;; Conprobamos que tenga debajo una escalera
   2CD6 DD 7E 03      [19]  618     ld      a, e_y(ix)
   2CD9 FD 86 07      [19]  619     add     e_h(iy)
   2CDC FD 96 03      [19]  620     sub     e_y(iy)
   2CDF C0            [11]  621     ret     nz
                            622 
...
Hexadecimal [16-Bits]
   ...
   2CE0 DD 7E 09      [19]  623     ld      a, e_ladder(ix)
   2CE3 F6 04         [ 7]  624     or      #e_ladder_dentro
   2CE5 DD 77 09      [19]  625     ld      e_ladder(ix), a
   2CE8 C9            [10]  626     ret
                            627 
   2CE9                     628 permitir_bajar_mas_x:
                            629 
   2CE9 DD 7E 09      [19]  630     ld      a, e_ladder(ix)
   2CEC D6 04         [ 7]  631     sub     #e_ladder_dentro
   2CEE DD 77 09      [19]  632     ld      e_ladder(ix), a
                            633 
   2CF1 DD 7E 09      [19]  634     ld      a, e_ladder(ix)
   2CF4 F6 02         [ 7]  635     or      #e_ladder_down
   2CF6 DD 77 09      [19]  636     ld      e_ladder(ix), a
                            637 
   2CF9 C9            [10]  638     ret
                            639 
   2CFA                     640 no_more_ladders_x:
                            641 
   2CFA FD 7E 03      [19]  642     ld      a, e_y(iy)
   2CFD FD 96 07      [19]  643     sub     e_h(iy)
   2D00 47            [ 4]  644     ld      b, a
   2D01 DD 7E 03      [19]  645     ld      a, e_y(ix)
   2D04 A8            [ 4]  646     xor     b
   2D05 C0            [11]  647     ret     nz
                            648 
                            649     ;;ld      e_ladder(ix), #e_ladder_nothing
                            650 
   2D06 DD 7E 09      [19]  651     ld      a, e_ladder(ix)
   2D09 E6 02         [ 7]  652     and     #e_ladder_down
   2D0B C8            [11]  653     ret     z
                            654 
   2D0C DD 7E 09      [19]  655     ld      a, e_ladder(ix)
   2D0F D6 02         [ 7]  656     sub     #e_ladder_down
   2D11 DD 77 09      [19]  657     ld      e_ladder(ix), a
                            658 
   2D14 C9            [10]  659     ret
                            660 
                            661 ;;-----------------------------------------------------------------------------------
                            662 ;; Encima de la escalera, para evitar que siga subiendo
   2D15                     663 no_collision_ladder_up:
                            664 
   2D15 DD 7E 01      [19]  665     ld      a, e_object(ix)
   2D18 E6 01         [ 7]  666     and     #e_object_hero
   2D1A 20 00         [12]  667     jr      nz, no_collision_ladder_up_ix
                            668 
   2D1C                     669 no_collision_ladder_up_ix:
                            670 
   2D1C DD 7E 09      [19]  671     ld      a, e_ladder(ix)
   2D1F E6 01         [ 7]  672     and     #e_ladder_up
   2D21 CA 25 2C      [10]  673     jp      z, comprobar_ladder_y_down
   2D24 DD 7E 09      [19]  674     ld      a, e_ladder(ix)
   2D27 D6 01         [ 7]  675     sub     #e_ladder_up
   2D29 DD 77 09      [19]  676     ld      e_ladder(ix), a
   2D2C C3 25 2C      [10]  677     jp      comprobar_ladder_y_down
...
Hexadecimal [16-Bits]
   ...
   2D2F C9            [10]  678     ret
                            679 
                            680 ;;-----------------------------------------------------------------------------------
                            681 ;; Debajo de la escalera, para evitar atraviese el suelo bajando
   2D30                     682 no_collision_ladder_down:
                            683 
   2D30 DD 7E 01      [19]  684     ld      a, e_object(ix)
   2D33 E6 01         [ 7]  685     and     #e_object_hero
   2D35 20 00         [12]  686     jr      nz, no_collision_ladder_down_ix
                            687 
   2D37                     688 no_collision_ladder_down_ix:
                            689 
   2D37 DD 7E 09      [19]  690     ld      a, e_ladder(ix)
   2D3A E6 02         [ 7]  691     and     #e_ladder_down
   2D3C C8            [11]  692     ret     z
   2D3D DD 7E 09      [19]  693     ld      a, e_ladder(ix)
   2D40 D6 02         [ 7]  694     sub     #e_ladder_down
   2D42 DD 77 09      [19]  695     ld      e_ladder(ix), a
   2D45 C9            [10]  696     ret
                            697 
