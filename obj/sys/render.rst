...
Hexadecimal [16-Bits]
                             ...
                             29 
                             30 
   2FA8 C0                   31 m_front_buffer:  .db 0xC0
   2FA9 80                   32 m_back_buffer:   .db 0x80
                             33 
                             34 
   2FAA                      35 sys_render_handler::
                             36 
   2FAA 21 FF 2F      [10]   37     ld    	hl, #sys_render_update  ;;y se los mando al render
   2FAD 3E 04         [ 7]   38 	ld		 a, #e_type_render		;; Se envía en A el tipo que queramos usar
   2FAF CD 8C 33      [17]   39 	call  	man_entity_forall_matching
                             40 
   2FB2 C9            [10]   41     ret
                             42 
                             43 
                             44 ;;LIMPIA Y PREPARA UN NUEVO BUFFER
   2FB3                      45 sys_render_newScene:
   2FB3 CD E9 2F      [17]   46     call    sys_render_switchBuffers
                             47     ;;call    ren_init_backBuffer
   2FB6 C9            [10]   48     ret
                             49 
                             50 ;;INTERCAMBIA LOS BUFFERS
                             51 ;;REGISTROS DESTRUIDOS
   2FB7                      52 sys_render_clearBackBuffer::
                             53 
                             54     ;;ld      a, (m_front_buffer)
                             55     ;;ld      h, a
                             56     ;;ld      de, #0
                             57     ;;ld      bc, #0x4000
                             58     ;;ld      l, e
                             59 ;;
                             60     ;;call    cpct_memset_f8_asm
                             61 
   2FB7 21 00 C0      [10]   62     ld      hl, #0xC000
   2FBA 36 00         [10]   63     ld      (hl), #0
   2FBC 11 01 C0      [10]   64     ld      de, #0xC000 + 1
   2FBF 01 FF 3F      [10]   65     ld      bc, #0x4000 - 1
   2FC2 ED B0         [21]   66     ldir
                             67     
   2FC4 C9            [10]   68 ret
                             69 
                             70 ;; INICIALIZAMOS EL BACK BUFFER
                             71 ;;
   2FC5                      72 ren_init_backBuffer::
   2FC5 3A A9 2F      [13]   73     ld      a, (m_back_buffer)
   2FC8 67            [ 4]   74     ld      h, a
   2FC9 11 00 00      [10]   75     ld      de, #0
   2FCC 01 00 40      [10]   76     ld      bc, #0x4000
   2FCF 6B            [ 4]   77     ld      l, e
                             78 
   2FD0 CD 76 5E      [17]   79     call    cpct_memset_f8_asm
                             80 
   2FD3 C9            [10]   81 ret
                             82 
   2FD4                      83 sys_render_init::
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 60.
Hexadecimal [16-Bits]



   2FD4 0E 00         [ 7]   84     ld      c, #0
   2FD6 CD 69 5E      [17]   85     call    cpct_setVideoMode_asm
   0031                      86     cpctm_setBorder_asm HW_BLACK
                              1    .radix h
   0031                       2    cpctm_setBorder_raw_asm \HW_BLACK ;; [28] Macro that does the job, but requires a number value to be passed
                              1    .globl cpct_setPALColour_asm
   2FD9 21 10 14      [10]    2    ld   hl, #0x1410         ;; [3]  H=Hardware value of desired colour, L=Border INK (16)
   2FDC CD 41 5B      [17]    3    call cpct_setPALColour_asm  ;; [25] Set Palette colour of the border
                              3    .radix d
   2FDF 21 AD 0E      [10]   87     ld      hl, #_main_palette
   2FE2 11 10 00      [10]   88     ld      de, #16
   2FE5 CD B8 5A      [17]   89     call    cpct_setPalette_asm
                             90 
   2FE8 C9            [10]   91     ret
                             92 
   2FE9                      93 sys_render_switchBuffers:
   2FE9 3A A9 2F      [13]   94     ld      a, (m_back_buffer)
   2FEC 47            [ 4]   95     ld      b, a
   2FED 3A A8 2F      [13]   96     ld      a, (m_front_buffer)
   2FF0 32 A9 2F      [13]   97     ld      (m_back_buffer),a
   2FF3 78            [ 4]   98     ld      a,b 
   2FF4 32 A8 2F      [13]   99     ld      (m_front_buffer),a
                            100 
   2FF7 CB 38         [ 8]  101     srl     b        ;;con srl puedo desplazar cualquier registro (bit instructions), desplaza a la derecha
   2FF9 CB 38         [ 8]  102     srl     b
   2FFB 68            [ 4]  103     ld      l,b
   2FFC C3 AA 5D      [10]  104     jp      cpct_setVideoMemoryPage_asm
                            105 
                            106 
   2FFF                     107 sys_render_update::
                            108 
   2FFF                     109 render_or:
   2FFF 11 00 C0      [10]  110     ld      de, #0xC000
   3002 DD 4E 02      [19]  111     ld      c, e_x(ix) ;;eso significa ix + mas la distancia de y      ;;cargo en b la posicion Y de la entidad
   3005 DD 46 03      [19]  112     ld      b, e_y(ix)
   3008 CD A1 67      [17]  113     call    cpct_getScreenPtr_asm 
                            114 
                            115     ;; HL = Videoman
                            116     ;;push    hl ; 4 segundos
                            117     ;;poop    de ; 3 s
   300B EB            [ 4]  118     ex      de, hl ; 1s los cambia
                            119 
   300C 2E B6         [ 7]  120     ld      l, #0xB6
   300E CD 83 5D      [17]  121     call    cpct_setBlendMode_asm
                            122     
   3011 DD 6E 12      [19]  123     ld      l, e_sprite(ix)
   3014 DD 66 13      [19]  124     ld      h, e_sprite+1(ix)
                            125     ;;ld      b, e_h(ix)
                            126     ;;ld      c, e_w(ix)
                            127     ;;call    cpct_drawSprite_asm
   3017 DD 4E 07      [19]  128     ld      c, e_h(ix)
   301A DD 46 06      [19]  129     ld      b, e_w(ix)
   301D CD 56 67      [17]  130     call    cpct_drawSpriteBlended_asm
                            131 
                            132     ;; Comprobamos si la entidad tiene e_type_physics, ya que si no tiene solo pintamos
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 61.
Hexadecimal [16-Bits]



                            133     ;; una vez y eliminamos el e_type_render de la entidad
                            134 
   3020 DD 7E 00      [19]  135     ld      a, e_type(ix)
   3023 E6 02         [ 7]  136     and     #e_type_physics
   3025 C0            [11]  137     ret     nz
                            138 
   3026 DD 7E 00      [19]  139     ld      a, e_type(ix)
   3029 D6 04         [ 7]  140     sub     #e_type_render
   302B DD 77 00      [19]  141     ld      e_type(ix), a
                            142 
   302E C9            [10]  143     ret
                            144 
                            145 
                            146 ;; UPDATE/DELETE
                            147 ;;      Pinta con XOR el sprite en la posición anterior por tanto lo elimina
                            148 ;;
   302F                     149 update_XOR_borrar_IX::
                            150 
   302F 2E AE         [ 7]  151     ld      l, #0xAE
   3031 CD 83 5D      [17]  152     call    cpct_setBlendMode_asm
                            153 
   3034 11 00 C0      [10]  154     ld      de, #0xC000
   3037 DD 4E 02      [19]  155     ld      c, e_x(ix) ;;eso significa ix + mas la distancia de y      ;;cargo en b la posicion Y de la entidad
   303A DD 46 03      [19]  156     ld      b, e_y(ix)
   303D CD A1 67      [17]  157     call    cpct_getScreenPtr_asm
                            158 
   3040 EB            [ 4]  159     ex      de, hl
                            160 
   3041 DD 6E 12      [19]  161     ld      l, e_sprite(ix)
   3044 DD 66 13      [19]  162     ld      h, e_sprite+1(ix)
   3047 DD 4E 07      [19]  163     ld      c, e_h(ix)
   304A DD 46 06      [19]  164     ld      b, e_w(ix)
   304D CD 56 67      [17]  165     call    cpct_drawSpriteBlended_asm
                            166 
   3050 C9            [10]  167     ret
                            168 
                            169 ;; UPDATE/DELETE
                            170 ;;      Pinta con XOR el sprite en la posición en la que está
                            171 ;;
   3051                     172 update_XOR_borrar_IY::
                            173 
   3051                     174 delete_normal:
   3051 2E AE         [ 7]  175     ld      l, #0xAE
   3053 CD 83 5D      [17]  176     call    cpct_setBlendMode_asm
                            177 
   3056 11 00 C0      [10]  178     ld      de, #0xC000
   3059 FD 4E 02      [19]  179     ld      c, e_x(iy) ;;eso significa ix + mas la distancia de y      ;;cargo en b la posicion Y de la entidad
   305C FD 46 03      [19]  180     ld      b, e_y(iy)
   305F CD A1 67      [17]  181     call    cpct_getScreenPtr_asm
                            182 
   3062 EB            [ 4]  183     ex      de, hl
                            184 
   3063 FD 6E 12      [19]  185     ld      l, e_sprite(iy)
   3066 FD 66 13      [19]  186     ld      h, e_sprite+1(iy)
   3069 FD 4E 07      [19]  187     ld      c, e_h(iy)
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 62.
Hexadecimal [16-Bits]



   306C FD 46 06      [19]  188     ld      b, e_w(iy)
   306F CD 56 67      [17]  189     call    cpct_drawSpriteBlended_asm
                            190 
   3072 C9            [10]  191     ret    
