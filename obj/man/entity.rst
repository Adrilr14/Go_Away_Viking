...
Hexadecimal [16-Bits]
                             ...
                             30 
                             31 ;;entity_vector:
                             32 ;;DefineNEntities entity_vector, max_entities
                             33 
                             34 
                             35 ;;m_num_entities::        .db 0
   3073 00                   36 type_match::            .db 0
   3074 00                   37 type_pairs::            .db 0
   3075 00                   38 type_ladder_invisble::  .db 0
                             39 
                             40 ;;m_entities::
   3076 78 30                41 m_first_entity_free:: .dw m_entity_array
   3078                      42 m_entity_array:: .ds max_entities * sizeof_e
   3230 00                   43 m_end_array:: .db 0     ;; Ponemos un byte a 0 al final de nuestro array de entidades y así comprobamos que es el final
                             44 
                             45 
   3231                      46 man_entity_getEntityVector_IX::
   3231 DD 21 78 30   [14]   47     ld      ix, #m_entity_array
   3235 C9            [10]   48     ret
                             49 
                             50 ;; GET ENTITY HERO
                             51 ;;      Devuelve en IY la dirección de memoria de la entidad hero 
   3236                      52 man_entity_getEntity_hero_IY::
                             53     ;; La entidad hero siempre es la primera
   3236 FD 21 78 30   [14]   54     ld      iy, #m_entity_array
   323A C9            [10]   55     ret
                             56 
                             57 
   323B                      58 man_entity_init::
                             59 ;;1st free entity at the start od entities storage
   323B 21 78 30      [10]   60     ld      hl, #m_entity_array
   323E 22 76 30      [16]   61     ld      (m_first_entity_free), hl
                             62     ;; 1st free entity with a 0 as first byte (no-entity.......)
   3241 36 00         [10]   63     ld      (hl), #0
   3243 C9            [10]   64     ret
                             65 
                             66 ;; CREATE ALL ENTITIES OF THE LEVEL
                             67 ;;      HL: Pointer to the entities level
                             68 ;;       A: Number of entities
   3244                      69 man_entity_create::
                             70 
                             71     ;;cp      #1
                             72     ;;jr      z, create_entities_l1
                             73 
   3244 3A A5 52      [13]   74     ld      a, (num_level)
   3247 FE 02         [ 7]   75     cp      #2
   3249 28 5F         [12]   76     jr      z, create_entities_l2
                             77  
   324B FE 03         [ 7]   78     cp      #3
   324D 28 65         [12]   79     jr      z, create_entities_l3
                             80 
   324F FE 04         [ 7]   81     cp      #4
   3251 28 6B         [12]   82     jr      z, create_entities_l4
                             83 
   3253 FE 05         [ 7]   84     cp      #5
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 62.
Hexadecimal [16-Bits]



   3255 28 71         [12]   85     jr      z, create_entities_l5
                             86 
   3257 FE 06         [ 7]   87     cp      #6
   3259 28 77         [12]   88     jr      z, create_entities_l6
                             89 
   325B FE 07         [ 7]   90     cp      #7
   325D 28 7D         [12]   91     jr      z, create_entities_l7
                             92 
   325F FE 08         [ 7]   93     cp      #8
   3261 CA E6 32      [10]   94     jp      z, create_entities_l8
                             95 
   3264 FE 09         [ 7]   96     cp      #9
   3266 CA F0 32      [10]   97     jp      z, create_entities_l9
                             98 
   3269 FE 0A         [ 7]   99     cp      #10
   326B CA FA 32      [10]  100     jp      z, create_entities_l10
                            101 
   326E FE 0B         [ 7]  102     cp      #11
   3270 CA 04 33      [10]  103     jp      z, create_entities_l11
                            104 
   3273 FE 0C         [ 7]  105     cp      #12
   3275 CA 0E 33      [10]  106     jp      z, create_entities_l12
                            107 
   3278 FE 0D         [ 7]  108     cp      #13
   327A CA 18 33      [10]  109     jp      z, create_entities_l13
                            110 
   327D FE 0E         [ 7]  111     cp      #14
   327F CA 22 33      [10]  112     jp      z, create_entities_l14
                            113 
   3282 FE 0F         [ 7]  114     cp      #15
   3284 CA 2C 33      [10]  115     jp      z, create_entities_l15
                            116 
   3287 FE 10         [ 7]  117     cp      #16
   3289 CA 36 33      [10]  118     jp      z, create_entities_l16
                            119 
   328C FE 11         [ 7]  120     cp      #17
   328E CA 40 33      [10]  121     jp      z, create_entities_l17
                            122 
   3291 FE 12         [ 7]  123     cp      #18
   3293 CA 4A 33      [10]  124     jp      z, create_entities_l18
                            125 
   3296 FE 13         [ 7]  126     cp      #19
   3298 CA 54 33      [10]  127     jp      z, create_entities_l19
                            128 
   329B FE 14         [ 7]  129     cp      #20
   329D CA 5E 33      [10]  130     jp      z, create_entities_l20
                            131 
   32A0                     132 create_entities_l1:
   32A0 ED 5B 76 30   [20]  133     ld      de, (m_first_entity_free)
   32A4 01 3C 00      [10]  134     ld      bc, #sizeof_e * num_entities_l1
   32A7 ED B0         [21]  135     ldir    ;;coge lo que hay en hl, lo copia de uno a uno en de, el numero de veces que tenga bc  -->esto lo hace memcpy
   32A9 C9            [10]  136     ret
                            137 
   32AA                     138 create_entities_l2:
   32AA ED 5B 76 30   [20]  139     ld      de, (m_first_entity_free)
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 63.
Hexadecimal [16-Bits]



   32AE 01 8C 00      [10]  140     ld      bc, #sizeof_e * num_entities_l2
   32B1 ED B0         [21]  141     ldir    ;;coge lo que hay en hl, lo copia de uno a uno en de, el numero de veces que tenga bc  -->esto lo hace memcpy
   32B3 C9            [10]  142     ret
                            143 
   32B4                     144 create_entities_l3:
   32B4 ED 5B 76 30   [20]  145     ld      de, (m_first_entity_free)
   32B8 01 C8 00      [10]  146     ld      bc, #sizeof_e * num_entities_l3
   32BB ED B0         [21]  147     ldir    ;;coge lo que hay en hl, lo copia de uno a uno en de, el numero de veces que tenga bc  -->esto lo hace memcpy
   32BD C9            [10]  148     ret
                            149 
   32BE                     150 create_entities_l4:
   32BE ED 5B 76 30   [20]  151     ld      de, (m_first_entity_free)
   32C2 01 A0 00      [10]  152     ld      bc, #sizeof_e * num_entities_l4
   32C5 ED B0         [21]  153     ldir    ;;coge lo que hay en hl, lo copia de uno a uno en de, el numero de veces que tenga bc  -->esto lo hace memcpy
   32C7 C9            [10]  154     ret
                            155 
   32C8                     156 create_entities_l5:
   32C8 ED 5B 76 30   [20]  157     ld      de, (m_first_entity_free)
   32CC 01 F0 00      [10]  158     ld      bc, #sizeof_e * num_entities_l5
   32CF ED B0         [21]  159     ldir    ;;coge lo que hay en hl, lo copia de uno a uno en de, el numero de veces que tenga bc  -->esto lo hace memcpy
   32D1 C9            [10]  160     ret
                            161 
   32D2                     162 create_entities_l6:
   32D2 ED 5B 76 30   [20]  163     ld      de, (m_first_entity_free)
   32D6 01 A0 00      [10]  164     ld      bc, #sizeof_e * num_entities_l6
   32D9 ED B0         [21]  165     ldir    ;;coge lo que hay en hl, lo copia de uno a uno en de, el numero de veces que tenga bc  -->esto lo hace memcpy
   32DB C9            [10]  166     ret
                            167 
   32DC                     168 create_entities_l7:
   32DC ED 5B 76 30   [20]  169     ld      de, (m_first_entity_free)
   32E0 01 F0 00      [10]  170     ld      bc, #sizeof_e * num_entities_l7
   32E3 ED B0         [21]  171     ldir    ;;coge lo que hay en hl, lo copia de uno a uno en de, el numero de veces que tenga bc  -->esto lo hace memcpy
   32E5 C9            [10]  172     ret
                            173 
   32E6                     174 create_entities_l8:
   32E6 ED 5B 76 30   [20]  175     ld      de, (m_first_entity_free)
   32EA 01 F0 00      [10]  176     ld      bc, #sizeof_e * num_entities_l8
   32ED ED B0         [21]  177     ldir    ;;coge lo que hay en hl, lo copia de uno a uno en de, el numero de veces que tenga bc  -->esto lo hace memcpy
   32EF C9            [10]  178     ret
                            179 
   32F0                     180 create_entities_l9:
   32F0 ED 5B 76 30   [20]  181     ld      de, (m_first_entity_free)
   32F4 01 F0 00      [10]  182     ld      bc, #sizeof_e * num_entities_l9
   32F7 ED B0         [21]  183     ldir    ;;coge lo que hay en hl, lo copia de uno a uno en de, el numero de veces que tenga bc  -->esto lo hace memcpy
   32F9 C9            [10]  184     ret
                            185 
   32FA                     186 create_entities_l10:
   32FA ED 5B 76 30   [20]  187     ld      de, (m_first_entity_free)
   32FE 01 54 01      [10]  188     ld      bc, #sizeof_e * num_entities_l10
   3301 ED B0         [21]  189     ldir    ;;coge lo que hay en hl, lo copia de uno a uno en de, el numero de veces que tenga bc  -->esto lo hace memcpy
   3303 C9            [10]  190     ret
                            191 
   3304                     192 create_entities_l11:
   3304 ED 5B 76 30   [20]  193     ld      de, (m_first_entity_free)
   3308 01 DC 00      [10]  194     ld      bc, #sizeof_e * num_entities_l11
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 64.
Hexadecimal [16-Bits]



   330B ED B0         [21]  195     ldir    ;;coge lo que hay en hl, lo copia de uno a uno en de, el numero de veces que tenga bc  -->esto lo hace memcpy
   330D C9            [10]  196     ret
                            197 
   330E                     198 create_entities_l12:
   330E ED 5B 76 30   [20]  199     ld      de, (m_first_entity_free)
   3312 01 F0 00      [10]  200     ld      bc, #sizeof_e * num_entities_l12
   3315 ED B0         [21]  201     ldir    ;;coge lo que hay en hl, lo copia de uno a uno en de, el numero de veces que tenga bc  -->esto lo hace memcpy
   3317 C9            [10]  202     ret
                            203 
   3318                     204 create_entities_l13:
   3318 ED 5B 76 30   [20]  205     ld      de, (m_first_entity_free)
   331C 01 DC 00      [10]  206     ld      bc, #sizeof_e * num_entities_l13
   331F ED B0         [21]  207     ldir    ;;coge lo que hay en hl, lo copia de uno a uno en de, el numero de veces que tenga bc  -->esto lo hace memcpy
   3321 C9            [10]  208     ret
                            209 
   3322                     210 create_entities_l14:
   3322 ED 5B 76 30   [20]  211     ld      de, (m_first_entity_free)
   3326 01 40 01      [10]  212     ld      bc, #sizeof_e * num_entities_l14
   3329 ED B0         [21]  213     ldir    ;;coge lo que hay en hl, lo copia de uno a uno en de, el numero de veces que tenga bc  -->esto lo hace memcpy
   332B C9            [10]  214     ret
                            215 
   332C                     216 create_entities_l15:
   332C ED 5B 76 30   [20]  217     ld      de, (m_first_entity_free)
   3330 01 54 01      [10]  218     ld      bc, #sizeof_e * num_entities_l15
   3333 ED B0         [21]  219     ldir    ;;coge lo que hay en hl, lo copia de uno a uno en de, el numero de veces que tenga bc  -->esto lo hace memcpy
   3335 C9            [10]  220     ret
                            221 
   3336                     222 create_entities_l16:
   3336 ED 5B 76 30   [20]  223     ld      de, (m_first_entity_free)
   333A 01 18 01      [10]  224     ld      bc, #sizeof_e * num_entities_l16
   333D ED B0         [21]  225     ldir    ;;coge lo que hay en hl, lo copia de uno a uno en de, el numero de veces que tenga bc  -->esto lo hace memcpy
   333F C9            [10]  226     ret
                            227 
   3340                     228 create_entities_l17:
   3340 ED 5B 76 30   [20]  229     ld      de, (m_first_entity_free)
   3344 01 B8 01      [10]  230     ld      bc, #sizeof_e * num_entities_l17
   3347 ED B0         [21]  231     ldir    ;;coge lo que hay en hl, lo copia de uno a uno en de, el numero de veces que tenga bc  -->esto lo hace memcpy
   3349 C9            [10]  232     ret
                            233 
   334A                     234 create_entities_l18:
   334A ED 5B 76 30   [20]  235     ld      de, (m_first_entity_free)
   334E 01 A4 01      [10]  236     ld      bc, #sizeof_e * num_entities_l18
   3351 ED B0         [21]  237     ldir    ;;coge lo que hay en hl, lo copia de uno a uno en de, el numero de veces que tenga bc  -->esto lo hace memcpy
   3353 C9            [10]  238     ret
                            239 
   3354                     240 create_entities_l19:
   3354 ED 5B 76 30   [20]  241     ld      de, (m_first_entity_free)
   3358 01 40 01      [10]  242     ld      bc, #sizeof_e * num_entities_l19
   335B ED B0         [21]  243     ldir    ;;coge lo que hay en hl, lo copia de uno a uno en de, el numero de veces que tenga bc  -->esto lo hace memcpy
   335D C9            [10]  244     ret
                            245 
   335E                     246 create_entities_l20:
   335E ED 5B 76 30   [20]  247     ld      de, (m_first_entity_free)
   3362 01 68 01      [10]  248     ld      bc, #sizeof_e * num_entities_l20
   3365 ED B0         [21]  249     ldir    ;;coge lo que hay en hl, lo copia de uno a uno en de, el numero de veces que tenga bc  -->esto lo hace memcpy
...
Hexadecimal [16-Bits]
   ...
   3367 C9            [10]  250     ret
                            251 
                            252 ;;DESTROY ALL ENTITIES
                            253 ;;
   3368                     254 man_entity_destroy::
                            255 
   3368 21 78 30      [10]  256     ld      hl, #m_entity_array
   336B 36 00         [10]  257     ld      (hl), #0
   336D 11 79 30      [10]  258     ld      de, #m_entity_array + 1
   3370 01 B7 01      [10]  259     ld      bc, #max_entities * sizeof_e - 1
   3373 ED B0         [21]  260     ldir
                            261 
   3375 C9            [10]  262 ret
                            263 
                            264 ;;CALL A FUNCTION FOR ALL ENTITIES
                            265 ;;      HL: Pointer to the function to be called
                            266 ;;      IMPORTANT: Function at HL must preserve IX
                            267 
   3376                     268 man_entity_forall::
   3376 22 83 33      [16]  269     ld      (update_call), hl      ;; set function to be.....
   3379 DD 21 78 30   [14]  270     ld      ix, #m_entity_array   ;; IX points to first
                            271 
                            272     ;;check if entity is valid
                            273     ;; if this first byte = 0, its not a valid entity
   337D                     274 next_entity:
   337D DD 7E 00      [19]  275     ld      a, e_type(ix)
   3380 B7            [ 4]  276     or      a 
   3381 C8            [11]  277     ret     z
                            278 
                            279     ;;Entity is valid, call the function
                     0310   280 update_call = .+1
   3382 CD 83 33      [17]  281     call    update_call
                            282 
                            283     ;;Point to next entity and repeat
   3385 01 14 00      [10]  284     ld      bc, #sizeof_e
   3388 DD 09         [15]  285     add     ix, bc
   338A 18 F1         [12]  286     jr      next_entity
                            287 
                            288 
                            289 ;;CALL A FUNCTION FOR ALL ENTITIES WITH A SPECIFIC TYPE
                            290 ;;      HL: Pointer to the function to be called
                            291 ;;       A: Type to match
                            292 ;;      IMPORTANT: Function at HL must preserve IX
   338C                     293 man_entity_forall_matching::
                            294 
   338C 32 73 30      [13]  295     ld      (type_match), a
   338F 22 A7 33      [16]  296     ld      (update_call_match), hl      ;; set function to be.....
   3392 DD 21 78 30   [14]  297     ld      ix, #m_entity_array   ;; IX points to first
                            298     
                            299     ;;check if entity is valid
                            300     ;; if this first byte = 0, its not a valid entity
   3396                     301 next_entity_match:
   3396 DD 7E 00      [19]  302     ld      a, e_type(ix)
   3399 F6 00         [ 7]  303     or      #e_type_invalid        ;; También se puede comprobar con a
   339B C8            [11]  304     ret     z
...
Hexadecimal [16-Bits]
                            ...
                            305 
   339C 3A 73 30      [13]  306     ld      a, (type_match)
   339F 47            [ 4]  307     ld      b, a
   33A0 DD 7E 00      [19]  308     ld      a, e_type(ix)
   33A3 A0            [ 4]  309     and     b
   33A4 28 03         [12]  310     jr      z, next_one
                            311 
                            312     ;;Entity is valid, call the function
                     0334   313 update_call_match = .+1
   33A6 CD A7 33      [17]  314     call    update_call_match
                            315 
   33A9                     316 next_one:
                            317     ;;Point to next entity and repeat
   33A9 01 14 00      [10]  318     ld      bc, #sizeof_e
   33AC DD 09         [15]  319     add     ix, bc
   33AE 18 E6         [12]  320     jr      next_entity_match
                            321 
                            322 ;CALL A FUNCTION FOR A PAIR OF ENTITIES
                            323 ;;      HL: Pointer to the function to be called
                            324 ;;       A: Type to match
                            325 ;;      IMPORTANT: Function at HL must preserve IX and IY
   33B0                     326 man_entity_forall_pairs_matching::
                            327 
   33B0 32 74 30      [13]  328     ld      (type_pairs), a
   33B3 22 E9 33      [16]  329     ld      (update_call_pairs), hl      ;; set function to be.....
   33B6 DD 21 78 30   [14]  330     ld      ix, #m_entity_array   ;; IX points to first
                            331     
                            332     ;;check if entity is valid
                            333     ;; if this first byte = 0, its not a valid entity
   33BA                     334 next_first_entity:
   33BA DD 7E 00      [19]  335     ld      a, e_type(ix)
   33BD F6 00         [ 7]  336     or      #e_type_invalid        ;; También se puede comprobar con a
   33BF C8            [11]  337     ret     z
                            338 
   33C0 3A 74 30      [13]  339     ld      a, (type_pairs)
   33C3 47            [ 4]  340     ld      b, a
   33C4 DD 7E 00      [19]  341     ld      a, e_type(ix)
   33C7 A0            [ 4]  342     and     b
   33C8 28 28         [12]  343     jr      z, next_first_one
                            344 
   0357                     345     ld__e_ixl
   33CA DD 5D                 1    .dw #0x5DDD  ;; Opcode for ld e, ixl
   0359                     346     ld__d_ixh
   33CC DD 54                 1    .dw #0x54DD  ;; Opcode for ld d, ixh
   035B                     347     ld__iyl_e
   33CE FD 6B                 1    .dw #0x6BFD  ;; Opcode for ld iyl, e
   035D                     348     ld__iyh_d
   33D0 FD 62                 1    .dw #0x62FD  ;; Opcode for ld iyh, d
   33D2 01 14 00      [10]  349     ld      bc, #sizeof_e
   33D5 FD 09         [15]  350     add     iy, bc
                            351 
   33D7                     352 next_second_entity:
   33D7 FD 7E 00      [19]  353     ld      a, e_type(iy)
   33DA F6 00         [ 7]  354     or      #e_type_invalid        ;; También se puede comprobar con a
   33DC 28 14         [12]  355     jr      z, next_first_one
...
Hexadecimal [16-Bits]
                            ...
                            356 
   33DE 3A 74 30      [13]  357     ld      a, (type_pairs)
   33E1 47            [ 4]  358     ld      b, a
   33E2 DD 7E 00      [19]  359     ld      a, e_type(ix)
   33E5 A0            [ 4]  360     and     b
                            361     
   33E6 28 03         [12]  362     jr      z, next_second_one
                            363     ;;Entity is valid, call the function
                            364     
                     0376   365 update_call_pairs = .+1
   33E8 CD E9 33      [17]  366     call    update_call_pairs
                            367 
   33EB                     368 next_second_one:
                            369     ;;Point to next entity and repeat
   33EB 01 14 00      [10]  370     ld      bc, #sizeof_e
   33EE FD 09         [15]  371     add     iy, bc
   33F0 18 E5         [12]  372     jr      next_second_entity
                            373 
   33F2                     374 next_first_one:
                            375     ;;Point to next entity and repeat
   33F2 01 14 00      [10]  376     ld      bc, #sizeof_e
   33F5 DD 09         [15]  377     add     ix, bc
   33F7 18 C1         [12]  378     jr      next_first_entity
                            379 
                            380 
                            381 ;;CALL A FUNCTION FOR ALL ENTITIES LADDERS
                            382 ;;      HL: Pointer to the function to be called
                            383 ;;       A: Type to match
                            384 ;;      IMPORTANT: Function at HL must preserve IX
                            385 ;;
   33F9                     386 man_entity_ladder_invisible_matching::
   33F9 32 75 30      [13]  387     ld      (type_ladder_invisble), a
   33FC 22 14 34      [16]  388     ld      (comprobar_x), hl      ;; set function to be.....
   33FF FD 21 78 30   [14]  389     ld      iy, #m_entity_array   ;; IX points to first
                            390     
                            391     ;;check if entity is valid
                            392     ;; if this first byte = 0, its not a valid entity
   3403                     393 next_ladder_invisible_match:
   3403 FD 7E 00      [19]  394     ld      a, e_type(iy)
   3406 F6 00         [ 7]  395     or      #e_type_invalid        ;; También se puede comprobar con a
   3408 C8            [11]  396     ret     z
                            397 
   3409 3A 75 30      [13]  398     ld      a, (type_ladder_invisble)
   340C 47            [ 4]  399     ld      b, a
   340D FD 7E 01      [19]  400     ld      a, e_object(iy)
   3410 A0            [ 4]  401     and     b
   3411 28 03         [12]  402     jr      z, next_ladder_invisible
                            403 
                            404     ;;Entity is valid, call the function
                     03A1   405 comprobar_x = .+1
   3413 CD 14 34      [17]  406     call    comprobar_x
                            407 
   3416                     408 next_ladder_invisible:
                            409     ;;Point to next entity and repeat
   3416 01 14 00      [10]  410     ld      bc, #sizeof_e
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 68.
Hexadecimal [16-Bits]



   3419 FD 09         [15]  411     add     iy, bc
   341B 18 E6         [12]  412     jr      next_ladder_invisible_match
