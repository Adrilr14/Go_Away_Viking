...
#PALETTE=0 2 3 4 6 9 11 12 13 15 16 18 20 24 25 26
PALETTE=0 3 6 6 11 11 13 13 16 16 18 18 24 24 26 26
$(eval $(call IMG2SP, SET_MODE        , 0                  ))  
$(eval $(call IMG2SP, SET_FOLDER      , src/sprites/               ))
$(eval $(call IMG2SP, SET_PALETTE_FW  , $(PALETTE)         ))
$(eval $(call IMG2SP, CONVERT_PALETTE , $(PALETTE), main_palette ))
$(eval $(call IMG2SP, CONVERT, img/viking.png , 12, 16, viking_sp))
$(eval $(call IMG2SP, CONVERT, img/enemy.png , 12, 16, enemy_sp))
$(eval $(call IMG2SP, CONVERT, img/key.png , 4, 8, key_sp))
$(eval $(call IMG2SP, CONVERT, img/hammer.png , 4, 12, hammer_sp))
$(eval $(call IMG2SP, CONVERT, img/hammer_lado.png , 8, 8, hammer_lado_sp))
$(eval $(call IMG2SP, CONVERT, img/tilesProt.png , 4, 4, tiles0_sp, ,tilesProt))
$(eval $(call IMG2SP, CONVERT, img/tilesProt2.png , 4, 4, tiles1_sp, ,tilesProt2))
$(eval $(call IMG2SP, CONVERT, img/tilesPrince.png , 4, 4, tiles2_sp, ,tilesPrince))
...
$(eval $(call IMG2SP, CONVERT         , img/menu.png , 0, 0, screen_menu))
