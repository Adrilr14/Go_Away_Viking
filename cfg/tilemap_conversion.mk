...
$(eval $(call TMX2DATA, SET_FOLDER      , src/assets/tilemaps/ ))
#$(eval $(call TMX2DATA, CONVERT, img/level0.tmx, tilemap_00 )) 
$(eval $(call TMX2DATA, CONVERT, img/level1.tmx, tilemap_01 ))
$(eval $(call TMX2DATA, CONVERT, img/level2.tmx, tilemap_02 ))  
$(eval $(call TMX2DATA, CONVERT, img/level3.tmx, tilemap_03 ))  
$(eval $(call TMX2DATA, CONVERT, img/level4.tmx, tilemap_04 ))
$(eval $(call TMX2DATA, CONVERT, img/level5.tmx, tilemap_05 ))   
$(eval $(call TMX2DATA, CONVERT, img/level6.tmx, tilemap_06 ))
$(eval $(call TMX2DATA, CONVERT, img/level7.tmx, tilemap_07 ))
$(eval $(call TMX2DATA, CONVERT, img/level8.tmx, tilemap_08 ))
$(eval $(call TMX2DATA, CONVERT, img/level9.tmx, tilemap_09 ))
$(eval $(call TMX2DATA, CONVERT, img/level10.tmx, tilemap_10 ))   
$(eval $(call TMX2DATA, CONVERT, img/level11.tmx, tilemap_11 ))   
$(eval $(call TMX2DATA, CONVERT, img/level12.tmx, tilemap_12 ))
$(eval $(call TMX2DATA, CONVERT, img/level13.tmx, tilemap_13 ))
$(eval $(call TMX2DATA, CONVERT, img/level14.tmx, tilemap_14 ))
$(eval $(call TMX2DATA, CONVERT, img/level15.tmx, tilemap_15 ))
$(eval $(call TMX2DATA, CONVERT, img/level16.tmx, tilemap_16 ))
$(eval $(call TMX2DATA, CONVERT, img/level17.tmx, tilemap_17 ))
$(eval $(call TMX2DATA, CONVERT, img/level18.tmx, tilemap_18 ))
$(eval $(call TMX2DATA, CONVERT, img/level19.tmx, tilemap_19 ))
$(eval $(call TMX2DATA, CONVERT, img/level20.tmx, tilemap_20 ))
...
#$(eval $(call TMX2C,img/level0.tmx,level0,src/levels))
#$(eval $(call TMX2C,img/level1.tmx,level1,src/levels))
