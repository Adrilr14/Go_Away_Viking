...
PROJNAME   := juego
Z80CODELOC := 0x2F5     #0x250      # La fuente personalizada empieza en 0x40 y ocupa 200 entonces podemos empezar 
                        # arriba del todo gracias a las funciones creadas para la fuente personalizada,
                        # si no existieran esas funciones (la nueva función de drawString) 
                        # sería un error porque drawString no se puede llamar antes de 0x4000.
                        # La música empieza en el 0x250 y acaba en el 0x2F4
